...
// "double* GetColor(double x)"
public double GetColor(double /*(double)*/ x) {
...
// "void GetTable(double x1, double x2, int n, double* table)"
public void GetTable(double /*(double)*/ x1, double /*(double)*/ x2, int /*(int)*/ n, double /*(double*)*/ []table) {
...
// "void GetTable(double x1, double x2, int n, float* table)"
public void GetTable(double /*(double)*/ x1, double /*(double)*/ x2, int /*(int)*/ n, float /*(float*)*/ []table) {
	VTK_API.API_vtkColorTransferFunction.GetTable_1(this, x1, x2, n, table);
}
...
// "void BuildFunctionFromTable(double x1, double x2, int size, double* table)"
public void BuildFunctionFromTable(double /*(double)*/ x1, double /*(double)*/ x2, int /*(int)*/ size, double /*(double*)*/ []table) {
...
// "virtual vtkTypeBool GetClampingMinValue ()"
public bool GetClampingMinValue() {
	ReturnPointer returnPointer = new ReturnPointer(new bool());
...
// "virtual vtkTypeBool GetClampingMaxValue ()"
public bool GetClampingMaxValue() {
	ReturnPointer returnPointer = new ReturnPointer(new bool());
...
public void SetColorSpaceToStep() {
	VTK_API.API_vtkColorTransferFunction.SetColorSpaceToStep_0(this);
}
...
// "virtual void SetHSVWrap (vtkTypeBool _arg)"
public void SetHSVWrap(bool /*(vtkTypeBool)*/ _arg) {
...
// "virtual void SetNanOpacity (double _arg)"
public void SetNanOpacity(double /*(double)*/ _arg) {
	VTK_API.API_vtkColorTransferFunction.SetNanOpacity_0(this, _arg);
}
...
public double GetNanOpacity() {
	ReturnPointer returnPointer = new ReturnPointer(new double());
	VTK_API.API_vtkColorTransferFunction.GetNanOpacity_0(returnPointer.GetPtr(), this);
	return (double)returnPointer;
}
...
// "virtual void SetNanColorRGBA(double r, double g, double b, double a)"
public void SetNanColorRGBA(double /*(double)*/ r, double /*(double)*/ g, double /*(double)*/ b, double /*(double)*/ a) {
	VTK_API.API_vtkColorTransferFunction.SetNanColorRGBA_0(this, r, g, b, a);
}


// void SetNanColorRGBA(double rgba[4])
// "void SetNanColorRGBA(double rgba[4])"
public void SetNanColorRGBA(double /*(double[4])*/ []rgba) {
	VTK_API.API_vtkColorTransferFunction.SetNanColorRGBA_1(this, rgba);
}
...
// "virtual void SetUseBelowRangeColor (vtkTypeBool _arg)"
public void SetUseBelowRangeColor(bool /*(vtkTypeBool)*/ _arg) {
...
// "virtual vtkTypeBool GetUseBelowRangeColor ()"
public bool GetUseBelowRangeColor() {
	ReturnPointer returnPointer = new ReturnPointer(new bool());
...
// "virtual void SetUseAboveRangeColor (vtkTypeBool _arg)"
public void SetUseAboveRangeColor(bool /*(vtkTypeBool)*/ _arg) {
...
// "virtual vtkTypeBool GetUseAboveRangeColor ()"
public bool GetUseAboveRangeColor() {
	ReturnPointer returnPointer = new ReturnPointer(new bool());
...
// "void FillFromDataPointer(int n, double* ptr)"
public void FillFromDataPointer(int /*(int)*/ n, double /*(double*)*/ []ptr) {
