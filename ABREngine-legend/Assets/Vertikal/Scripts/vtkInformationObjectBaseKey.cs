...
// "static vtkInformationObjectBaseKey* MakeKey(const char* name, const char* location, const char* requiredClass=nullptr)"
public static vtkInformationObjectBaseKey MakeKey(string /*(char*)*/ name, string /*(char*)*/ location, string /*(char*)*/ requiredClass) {
	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	VTK_API.API_vtkInformationObjectBaseKey.MakeKey_0(returnPointer.GetPtr(), name, location, requiredClass);
	return (vtkInformationObjectBaseKey)(IntPtr)returnPointer;
}
