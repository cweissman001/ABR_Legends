...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkXMLPolyDataReader*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkXMLPolyDataReader* NewInstance()
// vtkXMLPolyDataReader *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkXMLPolyDataReader_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkXMLPolyDataReader*)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);

// static vtkXMLPolyDataReader* New()
// static vtkXMLPolyDataReader *New()
[DllImport("vtkplugin", EntryPoint="vtkXMLPolyDataReader_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkXMLPolyDataReader*)*/ return_value);

// vtkPolyData* GetOutput()
// vtkPolyData *GetOutput()
[DllImport("vtkplugin", EntryPoint="vtkXMLPolyDataReader_GetOutput_0")] public static extern 
bool GetOutput_0(out IntPtr /*(vtkPolyData*)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);

// vtkPolyData* GetOutput(int idx)
// vtkPolyData *GetOutput(int idx)
[DllImport("vtkplugin", EntryPoint="vtkXMLPolyDataReader_GetOutput_1")] public static extern 
bool GetOutput_1(out IntPtr /*(vtkPolyData*)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject, int /*(int)*/ idx);
...
bool GetNumberOfVerts_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);
...
bool GetNumberOfLines_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);
...
bool GetNumberOfStrips_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);
...
bool GetNumberOfPolys_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkXMLPolyDataReader*)*/ callingObject);
