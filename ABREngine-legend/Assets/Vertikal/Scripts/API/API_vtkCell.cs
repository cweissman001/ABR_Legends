...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, string /*(char*)*/ type);

// static vtkCell* SafeDownCast(vtkObjectBase * o)
// static vtkCell* SafeDownCast(vtkObjectBase *o)
[DllImport("vtkplugin", EntryPoint="vtkCell_SafeDownCast_0")] public static extern 
bool SafeDownCast_0(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkCell* NewInstance()
// vtkCell *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkCell_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// void Initialize(int npts, vtkIdType * pts, vtkPoints * p)
// void Initialize(int npts, vtkIdType *pts, vtkPoints *p)
[DllImport("vtkplugin", EntryPoint="vtkCell_Initialize_0")] public static extern 
bool Initialize_0(IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ npts, long[] /*(vtkIdType*)*/ pts, IntPtr /*(vtkPoints*)*/ p);
...
bool GetCellType_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int GetCellDimension()
// virtual int GetCellDimension()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetCellDimension_0")] public static extern 
bool GetCellDimension_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int IsLinear()
// virtual int IsLinear()
[DllImport("vtkplugin", EntryPoint="vtkCell_IsLinear_0")] public static extern 
bool IsLinear_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int RequiresInitialization()
// virtual int RequiresInitialization()
[DllImport("vtkplugin", EntryPoint="vtkCell_RequiresInitialization_0")] public static extern 
bool RequiresInitialization_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);
...
bool IsExplicitCell_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int RequiresExplicitFaceRepresentation()
// virtual int RequiresExplicitFaceRepresentation()
[DllImport("vtkplugin", EntryPoint="vtkCell_RequiresExplicitFaceRepresentation_0")] public static extern 
bool RequiresExplicitFaceRepresentation_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);
...
bool SetFaces_0(IntPtr /*(vtkCell*)*/ callingObject, long[] /*(vtkIdType*)*/ ARG_0);

// virtual vtkIdType* GetFaces()
// virtual vtkIdType *GetFaces()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetFaces_0")] public static extern 
bool GetFaces_0(out long[] /*(vtkIdType*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// vtkPoints* GetPoints()
// vtkPoints *GetPoints()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetPoints_0")] public static extern 
bool GetPoints_0(out IntPtr /*(vtkPoints*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// vtkIdType GetNumberOfPoints()
// vtkIdType GetNumberOfPoints()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetNumberOfPoints_0")] public static extern 
bool GetNumberOfPoints_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int GetNumberOfEdges()
// virtual int GetNumberOfEdges()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetNumberOfEdges_0")] public static extern 
bool GetNumberOfEdges_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int GetNumberOfFaces()
// virtual int GetNumberOfFaces()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetNumberOfFaces_0")] public static extern 
bool GetNumberOfFaces_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// vtkIdList* GetPointIds()
// vtkIdList *GetPointIds()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetPointIds_0")] public static extern 
bool GetPointIds_0(out IntPtr /*(vtkIdList*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// vtkIdType GetPointId(int ptId)
// vtkIdType GetPointId(int ptId)
[DllImport("vtkplugin", EntryPoint="vtkCell_GetPointId_0")] public static extern 
bool GetPointId_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ ptId);

// virtual vtkCell* GetEdge(int edgeId)
// virtual vtkCell *GetEdge(int edgeId)
[DllImport("vtkplugin", EntryPoint="vtkCell_GetEdge_0")] public static extern 
bool GetEdge_0(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ edgeId);

// virtual vtkCell* GetFace(int faceId)
// virtual vtkCell *GetFace(int faceId)
[DllImport("vtkplugin", EntryPoint="vtkCell_GetFace_0")] public static extern 
bool GetFace_0(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ faceId);
...
bool CellBoundary_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(vtkIdList*)*/ pts);
...
bool EvaluateLocation_0(IntPtr /*(vtkCell*)*/ callingObject, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, double /*(double[3])*/ []x, double[] /*(double*)*/ weights);
...
bool IntersectWithLine_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, double /*(double[3])*/ []p1, double /*(double[3])*/ []p2, double /*(double)*/ tol, IntPtr /*(double&)*/ t, double /*(double[3])*/ []x, double /*(double[3])*/ []pcoords, IntPtr /*(int&)*/ subId);

// virtual int Triangulate(int index, vtkIdList * ptIds, vtkPoints * pts)
// virtual int Triangulate(int index, vtkIdList *ptIds, vtkPoints *pts)
[DllImport("vtkplugin", EntryPoint="vtkCell_Triangulate_0")] public static extern 
bool Triangulate_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ index, IntPtr /*(vtkIdList*)*/ ptIds, IntPtr /*(vtkPoints*)*/ pts);
...
bool Derivatives_0(IntPtr /*(vtkCell*)*/ callingObject, int /*(int)*/ subId, double /*(double[3])*/ []pcoords, double[] /*(double*)*/ values, int /*(int)*/ dim, double[] /*(double*)*/ derivs);
...
bool GetBounds_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// double GetLength2()
// double GetLength2()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetLength2_0")] public static extern 
bool GetLength2_0(out double /*(double)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual int GetParametricCenter(double pcoords[3])
// virtual int GetParametricCenter(double pcoords[3])
[DllImport("vtkplugin", EntryPoint="vtkCell_GetParametricCenter_0")] public static extern 
bool GetParametricCenter_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, double /*(double[3])*/ []pcoords);

// virtual double GetParametricDistance(const double pcoords[3])
// virtual double GetParametricDistance(const double pcoords[3])
[DllImport("vtkplugin", EntryPoint="vtkCell_GetParametricDistance_0")] public static extern 
bool GetParametricDistance_0(out double /*(double)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject, double /*(double[3])*/ []pcoords);

// virtual int IsPrimaryCell()
// virtual int IsPrimaryCell()
[DllImport("vtkplugin", EntryPoint="vtkCell_IsPrimaryCell_0")] public static extern 
bool IsPrimaryCell_0(out int /*(int)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);

// virtual double* GetParametricCoords()
// virtual double *GetParametricCoords()
[DllImport("vtkplugin", EntryPoint="vtkCell_GetParametricCoords_0")] public static extern 
bool GetParametricCoords_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkCell*)*/ callingObject);
...
bool InterpolateFunctions_0(IntPtr /*(vtkCell*)*/ callingObject, double /*(double[3])*/ []ARG_0, double[] /*(double*)*/ ARG_1);
...
bool InterpolateDerivs_0(IntPtr /*(vtkCell*)*/ callingObject, double /*(double[3])*/ []ARG_0, double[] /*(double*)*/ ARG_1);
