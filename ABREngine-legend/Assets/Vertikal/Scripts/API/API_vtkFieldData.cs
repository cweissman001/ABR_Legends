...
bool New_0(out IntPtr /*(vtkFieldData*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkFieldData*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkFieldData* NewInstance()
// vtkFieldData *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkFieldData_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkFieldData*)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject);
...
bool Allocate_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, long /*(vtkIdType)*/ sz, long /*(vtkIdType)*/ ext);
...
bool GetNumberOfArrays_0(out int /*(int)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject);

// int AddArray(vtkAbstractArray * array)
// int AddArray(vtkAbstractArray *array)
[DllImport("vtkplugin", EntryPoint="vtkFieldData_AddArray_0")] public static extern 
bool AddArray_0(out int /*(int)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, IntPtr /*(vtkAbstractArray*)*/ array);
...
bool GetArray_0(out IntPtr /*(vtkDataArray*)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, int /*(int)*/ i);
...
bool GetArray_1(out IntPtr /*(vtkDataArray*)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, string /*(char*)*/ arrayName, IntPtr /*(int&)*/ index);

// vtkDataArray* GetArray(const char * arrayName)
// vtkDataArray *GetArray(const char *arrayName)
[DllImport("vtkplugin", EntryPoint="vtkFieldData_GetArray_2")] public static extern 
bool GetArray_2(out IntPtr /*(vtkDataArray*)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, string /*(char*)*/ arrayName);
...
bool GetAbstractArray_0(out IntPtr /*(vtkAbstractArray*)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, int /*(int)*/ i);
...
bool GetAbstractArray_1(out IntPtr /*(vtkAbstractArray*)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, string /*(char*)*/ arrayName, IntPtr /*(int&)*/ index);
...
bool GetAbstractArray_2(out IntPtr /*(vtkAbstractArray*)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, string /*(char*)*/ arrayName);

// int HasArray(const char * name)
// int HasArray(const char *name)
[DllImport("vtkplugin", EntryPoint="vtkFieldData_HasArray_0")] public static extern 
bool HasArray_0(out int /*(int)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, string /*(char*)*/ name);

// char* GetArrayName(int i)
// const char* GetArrayName(int i)
[DllImport("vtkplugin", EntryPoint="vtkFieldData_GetArrayName_0")] public static extern 
bool GetArrayName_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, int /*(int)*/ i);
...
bool GetActualMemorySize_0(out ulong /*(unsigned long)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkFieldData_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject);
...
bool GetArrayContainingComponent_0(out int /*(int)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, int /*(int)*/ i, IntPtr /*(int&)*/ arrayComp);

// int GetNumberOfComponents()
// int GetNumberOfComponents()
[DllImport("vtkplugin", EntryPoint="vtkFieldData_GetNumberOfComponents_0")] public static extern 
bool GetNumberOfComponents_0(out int /*(int)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject);

// vtkIdType GetNumberOfTuples()
// vtkIdType GetNumberOfTuples()
[DllImport("vtkplugin", EntryPoint="vtkFieldData_GetNumberOfTuples_0")] public static extern 
bool GetNumberOfTuples_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject);
...
bool InsertNextTuple_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkFieldData*)*/ callingObject, long /*(vtkIdType)*/ j, IntPtr /*(vtkFieldData*)*/ source);
