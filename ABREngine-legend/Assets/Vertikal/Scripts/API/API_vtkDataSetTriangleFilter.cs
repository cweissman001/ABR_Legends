...
bool New_0(out IntPtr /*(vtkDataSetTriangleFilter*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkDataSetTriangleFilter*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkDataSetTriangleFilter*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);
...
bool NewInstance_0(out IntPtr /*(vtkDataSetTriangleFilter*)*/ return_value, IntPtr /*(vtkDataSetTriangleFilter*)*/ callingObject);
...
bool SetTetrahedraOnly_0(IntPtr /*(vtkDataSetTriangleFilter*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetTetrahedraOnly_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkDataSetTriangleFilter*)*/ callingObject);
