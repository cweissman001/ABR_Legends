...
bool New_0(out IntPtr /*(vtkActor2DCollection*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkActor2DCollection*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkActor2DCollection*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkActor2DCollection* NewInstance()
// vtkActor2DCollection *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkActor2DCollection_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkActor2DCollection*)*/ return_value, IntPtr /*(vtkActor2DCollection*)*/ callingObject);
...
bool IsItemPresent_0(out int /*(int)*/ return_value, IntPtr /*(vtkActor2DCollection*)*/ callingObject, IntPtr /*(vtkActor2D*)*/ a);

// vtkActor2D* GetNextActor2D()
// vtkActor2D *GetNextActor2D()
[DllImport("vtkplugin", EntryPoint="vtkActor2DCollection_GetNextActor2D_0")] public static extern 
bool GetNextActor2D_0(out IntPtr /*(vtkActor2D*)*/ return_value, IntPtr /*(vtkActor2DCollection*)*/ callingObject);

// vtkActor2D* GetLastActor2D()
// vtkActor2D *GetLastActor2D()
[DllImport("vtkplugin", EntryPoint="vtkActor2DCollection_GetLastActor2D_0")] public static extern 
bool GetLastActor2D_0(out IntPtr /*(vtkActor2D*)*/ return_value, IntPtr /*(vtkActor2DCollection*)*/ callingObject);

// vtkActor2D* GetNextItem()
// vtkActor2D *GetNextItem()
[DllImport("vtkplugin", EntryPoint="vtkActor2DCollection_GetNextItem_0")] public static extern 
bool GetNextItem_0(out IntPtr /*(vtkActor2D*)*/ return_value, IntPtr /*(vtkActor2DCollection*)*/ callingObject);

// vtkActor2D* GetLastItem()
// vtkActor2D *GetLastItem()
[DllImport("vtkplugin", EntryPoint="vtkActor2DCollection_GetLastItem_0")] public static extern 
bool GetLastItem_0(out IntPtr /*(vtkActor2D*)*/ return_value, IntPtr /*(vtkActor2DCollection*)*/ callingObject);
