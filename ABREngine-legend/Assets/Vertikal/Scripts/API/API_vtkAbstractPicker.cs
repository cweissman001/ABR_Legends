...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAbstractPicker*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAbstractPicker* NewInstance()
// vtkAbstractPicker *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAbstractPicker_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAbstractPicker*)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject);

// virtual vtkRenderer* GetRenderer()
// virtual vtkRenderer *GetRenderer ()
[DllImport("vtkplugin", EntryPoint="vtkAbstractPicker_GetRenderer_0")] public static extern 
bool GetRenderer_0(out IntPtr /*(vtkRenderer*)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject);
...
bool GetSelectionPoint_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject);
...
bool GetPickPosition_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject);
...
bool Pick_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject, double /*(double)*/ selectionX, double /*(double)*/ selectionY, double /*(double)*/ selectionZ, IntPtr /*(vtkRenderer*)*/ renderer);

// int Pick(double selectionPt[3], vtkRenderer * ren)
// int Pick(double selectionPt[3], vtkRenderer *ren)
[DllImport("vtkplugin", EntryPoint="vtkAbstractPicker_Pick_1")] public static extern 
bool Pick_1(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject, double /*(double[3])*/ []selectionPt, IntPtr /*(vtkRenderer*)*/ ren);
...
bool Pick3DPoint_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject, double /*(double[3])*/ []ARG_0, IntPtr /*(vtkRenderer*)*/ ARG_1);
...
bool Pick3DRay_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject, double /*(double[3])*/ []ARG_0, double /*(double[4])*/ []ARG_1, IntPtr /*(vtkRenderer*)*/ ARG_2);
...
bool SetPickFromList_0(IntPtr /*(vtkAbstractPicker*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetPickFromList_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject);
...
bool GetPickList_0(out IntPtr /*(vtkPropCollection*)*/ return_value, IntPtr /*(vtkAbstractPicker*)*/ callingObject);
