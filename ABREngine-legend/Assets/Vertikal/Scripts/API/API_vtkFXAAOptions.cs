...
bool New_0(out IntPtr /*(vtkFXAAOptions*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkFXAAOptions*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkFXAAOptions* NewInstance()
// vtkFXAAOptions *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkFXAAOptions_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkFXAAOptions*)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetRelativeContrastThresholdMinValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetRelativeContrastThresholdMaxValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetRelativeContrastThreshold_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetHardContrastThresholdMinValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetHardContrastThresholdMaxValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetHardContrastThreshold_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetSubpixelBlendLimitMinValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetSubpixelBlendLimitMaxValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetSubpixelBlendLimit_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetSubpixelContrastThresholdMinValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetSubpixelContrastThresholdMaxValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetSubpixelContrastThreshold_0(out float /*(float)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetUseHighQualityEndpoints_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetEndpointSearchIterationsMinValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetEndpointSearchIterationsMaxValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
...
bool GetEndpointSearchIterations_0(out int /*(int)*/ return_value, IntPtr /*(vtkFXAAOptions*)*/ callingObject);
