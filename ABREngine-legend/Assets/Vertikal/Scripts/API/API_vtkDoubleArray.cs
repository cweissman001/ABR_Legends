...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkDoubleArray*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkDoubleArray*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkDoubleArray* NewInstance()
// vtkDoubleArray *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkDoubleArray_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkDoubleArray*)*/ return_value, IntPtr /*(vtkDoubleArray*)*/ callingObject);

// static vtkDoubleArray* New()
// static vtkDoubleArray* New()
[DllImport("vtkplugin", EntryPoint="vtkDoubleArray_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkDoubleArray*)*/ return_value);
...
bool FastDownCast_0(out IntPtr /*(vtkDoubleArray*)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ source);
...
bool GetDataTypeValueMin_0(out double /*(double)*/ return_value);
...
bool GetDataTypeValueMax_0(out double /*(double)*/ return_value);
