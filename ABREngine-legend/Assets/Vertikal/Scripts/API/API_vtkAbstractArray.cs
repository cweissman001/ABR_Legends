...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAbstractArray*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAbstractArray* NewInstance()
// vtkAbstractArray *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAbstractArray_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAbstractArray*)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool Allocate_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject, long /*(vtkIdType)*/ numValues, long /*(vtkIdType)*/ ext);
...
bool GetDataType_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);

// virtual int GetDataTypeSize()
// virtual int GetDataTypeSize()
[DllImport("vtkplugin", EntryPoint="vtkAbstractArray_GetDataTypeSize_0")] public static extern 
bool GetDataTypeSize_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);

// static int GetDataTypeSize(int type)
// static int GetDataTypeSize(int type)
[DllImport("vtkplugin", EntryPoint="vtkAbstractArray_GetDataTypeSize_1")] public static extern 
bool GetDataTypeSize_1(out int /*(int)*/ return_value, int /*(int)*/ type);
...
bool GetElementComponentSize_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool GetNumberOfComponentsMinValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool GetNumberOfComponentsMaxValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);

// int GetNumberOfComponents()
// int GetNumberOfComponents()
[DllImport("vtkplugin", EntryPoint="vtkAbstractArray_GetNumberOfComponents_0")] public static extern 
bool GetNumberOfComponents_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool GetComponentName_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject, long /*(vtkIdType)*/ component);

// bool HasAComponentName()
// bool HasAComponentName()
[DllImport("vtkplugin", EntryPoint="vtkAbstractArray_HasAComponentName_0")] public static extern 
bool HasAComponentName_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);

// int CopyComponentNames(vtkAbstractArray * da)
// int CopyComponentNames( vtkAbstractArray *da )
[DllImport("vtkplugin", EntryPoint="vtkAbstractArray_CopyComponentNames_0")] public static extern 
bool CopyComponentNames_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject, IntPtr /*(vtkAbstractArray*)*/ da);
...
bool GetNumberOfTuples_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool InsertNextTuple_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject, long /*(vtkIdType)*/ srcTupleIdx, IntPtr /*(vtkAbstractArray*)*/ source);
...
bool HasStandardMemoryLayout_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool GetVoidPointer_0(out IntPtr /*(IntPtr*)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject, long /*(vtkIdType)*/ valueIdx);
...
bool InterpolateTuple_0(IntPtr /*(vtkAbstractArray*)*/ callingObject, long /*(vtkIdType)*/ dstTupleIdx, IntPtr /*(vtkIdList*)*/ ptIndices, IntPtr /*(vtkAbstractArray*)*/ source, double[] /*(double*)*/ weights);
...
bool Resize_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject, long /*(vtkIdType)*/ numTuples);
...
bool GetSize_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);

// vtkIdType GetMaxId()
// vtkIdType GetMaxId()
[DllImport("vtkplugin", EntryPoint="vtkAbstractArray_GetMaxId_0")] public static extern 
bool GetMaxId_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool GetActualMemorySize_0(out ulong /*(unsigned long)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool GetName_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool GetDataTypeAsString_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool CreateArray_0(out IntPtr /*(vtkAbstractArray*)*/ return_value, int /*(int)*/ dataType);

// virtual int IsNumeric()
// virtual int IsNumeric()
[DllImport("vtkplugin", EntryPoint="vtkAbstractArray_IsNumeric_0")] public static extern 
bool IsNumeric_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);

// virtual vtkArrayIterator* NewIterator()
// virtual vtkArrayIterator* NewIterator()
[DllImport("vtkplugin", EntryPoint="vtkAbstractArray_NewIterator_0")] public static extern 
bool NewIterator_0(out IntPtr /*(vtkArrayIterator*)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);

// virtual vtkIdType GetDataSize()
// virtual vtkIdType GetDataSize()
[DllImport("vtkplugin", EntryPoint="vtkAbstractArray_GetDataSize_0")] public static extern 
bool GetDataSize_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool HasInformation_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool GetMaxDiscreteValues_0(out uint /*(unsigned int)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
...
bool GetArrayType_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ callingObject);
