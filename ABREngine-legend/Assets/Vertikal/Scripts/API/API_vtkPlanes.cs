...
bool New_0(out IntPtr /*(vtkPlanes*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPlanes*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPlanes*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkPlanes* NewInstance()
// vtkPlanes *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkPlanes_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkPlanes*)*/ return_value, IntPtr /*(vtkPlanes*)*/ callingObject);

// double EvaluateFunction(double x[3])
// double EvaluateFunction(double x[3])
[DllImport("vtkplugin", EntryPoint="vtkPlanes_EvaluateFunction_0")] public static extern 
bool EvaluateFunction_0(out double /*(double)*/ return_value, IntPtr /*(vtkPlanes*)*/ callingObject, double /*(double[3])*/ []x);
...
bool GetPoints_0(out IntPtr /*(vtkPoints*)*/ return_value, IntPtr /*(vtkPlanes*)*/ callingObject);
...
bool GetNormals_0(out IntPtr /*(vtkDataArray*)*/ return_value, IntPtr /*(vtkPlanes*)*/ callingObject);
...
bool GetNumberOfPlanes_0(out int /*(int)*/ return_value, IntPtr /*(vtkPlanes*)*/ callingObject);

// vtkPlane* GetPlane(int i)
// vtkPlane *GetPlane(int i)
[DllImport("vtkplugin", EntryPoint="vtkPlanes_GetPlane_0")] public static extern 
bool GetPlane_0(out IntPtr /*(vtkPlane*)*/ return_value, IntPtr /*(vtkPlanes*)*/ callingObject, int /*(int)*/ i);
