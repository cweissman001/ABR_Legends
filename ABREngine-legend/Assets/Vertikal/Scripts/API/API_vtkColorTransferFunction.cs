...
bool GetTable_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, double /*(double)*/ x1, double /*(double)*/ x2, int /*(int)*/ n, double[] /*(double*)*/ table);

// void GetTable(double x1, double x2, int n, float * table)
// void GetTable(double x1, double x2, int n, float* table)
[DllImport("vtkplugin", EntryPoint="vtkColorTransferFunction_GetTable_1")] public static extern 
bool GetTable_1(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, double /*(double)*/ x1, double /*(double)*/ x2, int /*(int)*/ n, float[] /*(float*)*/ table);
...
bool BuildFunctionFromTable_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, double /*(double)*/ x1, double /*(double)*/ x2, int /*(int)*/ size, double[] /*(double*)*/ table);
...
bool SetClamping_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);

// virtual vtkTypeBool GetClampingMinValue()
// virtual vtkTypeBool GetClampingMinValue ()
...
// virtual vtkTypeBool GetClampingMaxValue()
// virtual vtkTypeBool GetClampingMaxValue ()
...
// void SetColorSpaceToStep()
[DllImport("vtkplugin", EntryPoint="vtkColorTransferFunction_SetColorSpaceToStep_0")] public static extern 
bool SetColorSpaceToStep_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject);
...
// virtual void SetHSVWrap(vtkTypeBool _arg)
// virtual void SetHSVWrap (vtkTypeBool _arg)
[DllImport("vtkplugin", EntryPoint="vtkColorTransferFunction_SetHSVWrap_0")] public static extern 
bool SetHSVWrap_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
// virtual void SetNanOpacity(double _arg)
// virtual void SetNanOpacity (double _arg)
[DllImport("vtkplugin", EntryPoint="vtkColorTransferFunction_SetNanOpacity_0")] public static extern 
bool SetNanOpacity_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, double /*(double)*/ _arg);

// virtual double GetNanOpacity()
// virtual double GetNanOpacity ()
[DllImport("vtkplugin", EntryPoint="vtkColorTransferFunction_GetNanOpacity_0")] public static extern 
bool GetNanOpacity_0(IntPtr /*(IntPtr*)*/ return_value, IntPtr /*(vtkColorTransferFunction*)*/ callingObject);

// virtual void SetNanColorRGBA(double r, double g, double b, double a)
// virtual void SetNanColorRGBA(double r, double g, double b, double a)
[DllImport("vtkplugin", EntryPoint="vtkColorTransferFunction_SetNanColorRGBA_0")] public static extern 
bool SetNanColorRGBA_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, double /*(double)*/ r, double /*(double)*/ g, double /*(double)*/ b, double /*(double)*/ a);

// void SetNanColorRGBA(double rgba[4])
// void SetNanColorRGBA(double rgba[4])
[DllImport("vtkplugin", EntryPoint="vtkColorTransferFunction_SetNanColorRGBA_1")] public static extern 
bool SetNanColorRGBA_1(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, double /*(double[4])*/ []rgba);
...
// virtual void SetUseBelowRangeColor(vtkTypeBool _arg)
// virtual void SetUseBelowRangeColor (vtkTypeBool _arg)
[DllImport("vtkplugin", EntryPoint="vtkColorTransferFunction_SetUseBelowRangeColor_0")] public static extern 
bool SetUseBelowRangeColor_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
// virtual void SetUseAboveRangeColor(vtkTypeBool _arg)
// virtual void SetUseAboveRangeColor (vtkTypeBool _arg)
[DllImport("vtkplugin", EntryPoint="vtkColorTransferFunction_SetUseAboveRangeColor_0")] public static extern 
bool SetUseAboveRangeColor_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool FillFromDataPointer_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, int /*(int)*/ n, double[] /*(double*)*/ ptr);
...
bool SetAllowDuplicateScalars_0(IntPtr /*(vtkColorTransferFunction*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
