...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkDataArraySelection*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkDataArraySelection* NewInstance()
// vtkDataArraySelection *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkDataArraySelection_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkDataArraySelection*)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject);

// static vtkDataArraySelection* New()
// static vtkDataArraySelection* New()
[DllImport("vtkplugin", EntryPoint="vtkDataArraySelection_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkDataArraySelection*)*/ return_value);
...
bool ArrayIsEnabled_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject, string /*(char*)*/ name);

// int ArrayExists(const char * name)
// int ArrayExists(const char* name)
[DllImport("vtkplugin", EntryPoint="vtkDataArraySelection_ArrayExists_0")] public static extern 
bool ArrayExists_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject, string /*(char*)*/ name);
...
bool GetNumberOfArrays_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject);
...
bool GetNumberOfArraysEnabled_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject);
...
bool GetArrayName_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject, int /*(int)*/ index);
...
bool GetArrayIndex_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject, string /*(char*)*/ name);
...
bool GetEnabledArrayIndex_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject, string /*(char*)*/ name);

// int GetArraySetting(int index)
// int GetArraySetting(int index)
[DllImport("vtkplugin", EntryPoint="vtkDataArraySelection_GetArraySetting_0")] public static extern 
bool GetArraySetting_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject, int /*(int)*/ index);

// int GetArraySetting(const char * name)
// int GetArraySetting(const char* name)
[DllImport("vtkplugin", EntryPoint="vtkDataArraySelection_GetArraySetting_1")] public static extern 
bool GetArraySetting_1(out int /*(int)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject, string /*(char*)*/ name);

// void SetArraySetting(const char * name, int status)
// void SetArraySetting(const char* name, int status)
[DllImport("vtkplugin", EntryPoint="vtkDataArraySelection_SetArraySetting_0")] public static extern 
bool SetArraySetting_0(IntPtr /*(vtkDataArraySelection*)*/ callingObject, string /*(char*)*/ name, int /*(int)*/ status);
...
bool AddArray_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataArraySelection*)*/ callingObject, string /*(char*)*/ name, bool /*(bool)*/ state);
...
// void Union(vtkDataArraySelection* other)
[DllImport("vtkplugin", EntryPoint="vtkDataArraySelection_Union_0")] public static extern 
bool Union_0(IntPtr /*(vtkDataArraySelection*)*/ callingObject, IntPtr /*(vtkDataArraySelection*)*/ other);
