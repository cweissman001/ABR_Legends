...
bool New_0(out IntPtr /*(vtkAlgorithmOutput*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAlgorithmOutput*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAlgorithmOutput*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAlgorithmOutput* NewInstance()
// vtkAlgorithmOutput *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAlgorithmOutput_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAlgorithmOutput*)*/ return_value, IntPtr /*(vtkAlgorithmOutput*)*/ callingObject);
...
bool GetIndex_0(out int /*(int)*/ return_value, IntPtr /*(vtkAlgorithmOutput*)*/ callingObject);

// vtkAlgorithm* GetProducer()
// vtkAlgorithm* GetProducer()
[DllImport("vtkplugin", EntryPoint="vtkAlgorithmOutput_GetProducer_0")] public static extern 
bool GetProducer_0(out IntPtr /*(vtkAlgorithm*)*/ return_value, IntPtr /*(vtkAlgorithmOutput*)*/ callingObject);
