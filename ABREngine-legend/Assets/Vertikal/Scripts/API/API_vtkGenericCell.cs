...
bool New_0(out IntPtr /*(vtkGenericCell*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkGenericCell*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkGenericCell* NewInstance()
// vtkGenericCell *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkGenericCell*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool GetCellType_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int GetCellDimension()
// int GetCellDimension()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetCellDimension_0")] public static extern 
bool GetCellDimension_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int IsLinear()
// int IsLinear()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_IsLinear_0")] public static extern 
bool IsLinear_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int RequiresInitialization()
// int RequiresInitialization()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_RequiresInitialization_0")] public static extern 
bool RequiresInitialization_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool RequiresExplicitFaceRepresentation_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// void SetFaces(vtkIdType * faces)
// void SetFaces(vtkIdType *faces)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_SetFaces_0")] public static extern 
bool SetFaces_0(IntPtr /*(vtkGenericCell*)*/ callingObject, long[] /*(vtkIdType*)*/ faces);

// vtkIdType* GetFaces()
// vtkIdType *GetFaces()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetFaces_0")] public static extern 
bool GetFaces_0(out long[] /*(vtkIdType*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int GetNumberOfEdges()
// int GetNumberOfEdges()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetNumberOfEdges_0")] public static extern 
bool GetNumberOfEdges_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int GetNumberOfFaces()
// int GetNumberOfFaces()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetNumberOfFaces_0")] public static extern 
bool GetNumberOfFaces_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// vtkCell* GetEdge(int edgeId)
// vtkCell *GetEdge(int edgeId)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetEdge_0")] public static extern 
bool GetEdge_0(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, int /*(int)*/ edgeId);

// vtkCell* GetFace(int faceId)
// vtkCell *GetFace(int faceId)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetFace_0")] public static extern 
bool GetFace_0(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, int /*(int)*/ faceId);
...
bool CellBoundary_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, int /*(int)*/ subId, double /*(double[3])*/ []pcoords, IntPtr /*(vtkIdList*)*/ pts);
...
bool EvaluateLocation_0(IntPtr /*(vtkGenericCell*)*/ callingObject, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, double /*(double[3])*/ []x, double[] /*(double*)*/ weights);
...
bool IntersectWithLine_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, double /*(double[3])*/ []p1, double /*(double[3])*/ []p2, double /*(double)*/ tol, IntPtr /*(double&)*/ t, double /*(double[3])*/ []x, double /*(double[3])*/ []pcoords, IntPtr /*(int&)*/ subId);

// int Triangulate(int index, vtkIdList * ptIds, vtkPoints * pts)
// int Triangulate(int index, vtkIdList *ptIds, vtkPoints *pts)
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_Triangulate_0")] public static extern 
bool Triangulate_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, int /*(int)*/ index, IntPtr /*(vtkIdList*)*/ ptIds, IntPtr /*(vtkPoints*)*/ pts);
...
bool Derivatives_0(IntPtr /*(vtkGenericCell*)*/ callingObject, int /*(int)*/ subId, double /*(double[3])*/ []pcoords, double[] /*(double*)*/ values, int /*(int)*/ dim, double[] /*(double*)*/ derivs);

// int GetParametricCenter(double pcoords[3])
// int GetParametricCenter(double pcoords[3])
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetParametricCenter_0")] public static extern 
bool GetParametricCenter_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject, double /*(double[3])*/ []pcoords);

// double* GetParametricCoords()
// double *GetParametricCoords()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetParametricCoords_0")] public static extern 
bool GetParametricCoords_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);

// int IsPrimaryCell()
// int IsPrimaryCell()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_IsPrimaryCell_0")] public static extern 
bool IsPrimaryCell_0(out int /*(int)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);
...
bool InterpolateFunctions_0(IntPtr /*(vtkGenericCell*)*/ callingObject, double /*(double[3])*/ []pcoords, double[] /*(double*)*/ weights);
...
bool InterpolateDerivs_0(IntPtr /*(vtkGenericCell*)*/ callingObject, double /*(double[3])*/ []pcoords, double[] /*(double*)*/ derivs);
...
bool InstantiateCell_0(out IntPtr /*(vtkCell*)*/ return_value, int /*(int)*/ cellType);

// vtkCell* GetRepresentativeCell()
// vtkCell* GetRepresentativeCell()
[DllImport("vtkplugin", EntryPoint="vtkGenericCell_GetRepresentativeCell_0")] public static extern 
bool GetRepresentativeCell_0(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkGenericCell*)*/ callingObject);
