...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAbstractTransform*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAbstractTransform* NewInstance()
// vtkAbstractTransform *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAbstractTransform*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject);
...
bool TransformPoint_2(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);

// double* TransformPoint(const double point[3])
// double *TransformPoint(const double point[3])
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_TransformPoint_3")] public static extern 
bool TransformPoint_3(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, double /*(double[3])*/ []point);

// float* TransformFloatPoint(float x, float y, float z)
// float *TransformFloatPoint(float x, float y, float z)
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_TransformFloatPoint_0")] public static extern 
bool TransformFloatPoint_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, float /*(float)*/ x, float /*(float)*/ y, float /*(float)*/ z);

// float* TransformFloatPoint(const float point[3])
// float *TransformFloatPoint(const float point[3])
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_TransformFloatPoint_1")] public static extern 
bool TransformFloatPoint_1(out float[] /*(float*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, float /*(float[3])*/ []point);

// double* TransformDoublePoint(double x, double y, double z)
// double *TransformDoublePoint(double x, double y, double z)
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_TransformDoublePoint_0")] public static extern 
bool TransformDoublePoint_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);

// double* TransformDoublePoint(const double point[3])
// double *TransformDoublePoint(const double point[3])
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_TransformDoublePoint_1")] public static extern 
bool TransformDoublePoint_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, double /*(double[3])*/ []point);
...
bool TransformNormalAtPoint_2(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, double /*(double[3])*/ []point, double /*(double[3])*/ []normal);

// double* TransformDoubleNormalAtPoint(const double point[3], const double normal[3])
// double *TransformDoubleNormalAtPoint(const double point[3], const double normal[3])
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_TransformDoubleNormalAtPoint_0")] public static extern 
bool TransformDoubleNormalAtPoint_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, double /*(double[3])*/ []point, double /*(double[3])*/ []normal);

// float* TransformFloatNormalAtPoint(const float point[3], const float normal[3])
// float *TransformFloatNormalAtPoint(const float point[3], const float normal[3])
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_TransformFloatNormalAtPoint_0")] public static extern 
bool TransformFloatNormalAtPoint_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, float /*(float[3])*/ []point, float /*(float[3])*/ []normal);
...
bool TransformVectorAtPoint_2(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, double /*(double[3])*/ []point, double /*(double[3])*/ []vector);

// double* TransformDoubleVectorAtPoint(const double point[3], const double vector[3])
// double *TransformDoubleVectorAtPoint(const double point[3], const double vector[3])
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_TransformDoubleVectorAtPoint_0")] public static extern 
bool TransformDoubleVectorAtPoint_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, double /*(double[3])*/ []point, double /*(double[3])*/ []vector);

// float* TransformFloatVectorAtPoint(const float point[3], const float vector[3])
// float *TransformFloatVectorAtPoint(const float point[3], const float vector[3])
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_TransformFloatVectorAtPoint_0")] public static extern 
bool TransformFloatVectorAtPoint_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, float /*(float[3])*/ []point, float /*(float[3])*/ []vector);
...
bool TransformPointsNormalsVectors_0(IntPtr /*(vtkAbstractTransform*)*/ callingObject, IntPtr /*(vtkPoints*)*/ inPts, IntPtr /*(vtkPoints*)*/ outPts, IntPtr /*(vtkDataArray*)*/ inNms, IntPtr /*(vtkDataArray*)*/ outNms, IntPtr /*(vtkDataArray*)*/ inVrs, IntPtr /*(vtkDataArray*)*/ outVrs, int /*(int)*/ nOptionalVectors, IntPtr /*(vtkDataArray**)*/ inVrsArr, IntPtr /*(vtkDataArray**)*/ outVrsArr);

// vtkAbstractTransform* GetInverse()
// vtkAbstractTransform *GetInverse()
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_GetInverse_0")] public static extern 
bool GetInverse_0(out IntPtr /*(vtkAbstractTransform*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject);
...
bool MakeTransform_0(out IntPtr /*(vtkAbstractTransform*)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject);

// virtual int CircuitCheck(vtkAbstractTransform * transform)
// virtual int CircuitCheck(vtkAbstractTransform *transform)
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_CircuitCheck_0")] public static extern 
bool CircuitCheck_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject, IntPtr /*(vtkAbstractTransform*)*/ transform);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkAbstractTransform_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkAbstractTransform*)*/ callingObject);
