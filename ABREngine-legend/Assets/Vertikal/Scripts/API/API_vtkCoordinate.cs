...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkCoordinate*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkCoordinate* NewInstance()
// vtkCoordinate *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkCoordinate_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkCoordinate*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject);

// static vtkCoordinate* New()
// static vtkCoordinate* New()
[DllImport("vtkplugin", EntryPoint="vtkCoordinate_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkCoordinate*)*/ return_value);
...
bool GetCoordinateSystem_0(out int /*(int)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject);
...
// void SetCoordinateSystemToPose()
[DllImport("vtkplugin", EntryPoint="vtkCoordinate_SetCoordinateSystemToPose_0")] public static extern 
bool SetCoordinateSystemToPose_0(IntPtr /*(vtkCoordinate*)*/ callingObject);
...
bool GetCoordinateSystemAsString_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject);
...
bool GetValue_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject);
...
bool GetReferenceCoordinate_0(out IntPtr /*(vtkCoordinate*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject);
...
bool GetViewport_0(out IntPtr /*(vtkViewport*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject);
...
bool GetComputedWorldValue_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ARG_0);
...
bool GetComputedViewportValue_0(out int[] /*(int*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ARG_0);
...
bool GetComputedDisplayValue_0(out int[] /*(int*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ARG_0);
...
bool GetComputedLocalDisplayValue_0(out int[] /*(int*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ARG_0);
...
bool GetComputedDoubleViewportValue_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ARG_0);
...
bool GetComputedDoubleDisplayValue_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ARG_0);
...
bool GetComputedValue_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ARG_0);
...
bool GetComputedUserDefinedValue_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkCoordinate*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ARG_0);
