...
bool New_0(out IntPtr /*(vtkVolumeProperty*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkVolumeProperty*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkVolumeProperty* NewInstance()
// vtkVolumeProperty *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkVolumeProperty*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool SetIndependentComponents_0(IntPtr /*(vtkVolumeProperty*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetIndependentComponentsMinValue_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetIndependentComponentsMaxValue_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetIndependentComponents_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetInterpolationTypeMinValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetInterpolationTypeMaxValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetInterpolationType_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetInterpolationTypeAsString_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetComponentWeight_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);
...
bool GetColorChannels_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);

// int GetColorChannels()
// int GetColorChannels()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetColorChannels_1")] public static extern 
bool GetColorChannels_1(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetGrayTransferFunction_0(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);

// vtkPiecewiseFunction* GetGrayTransferFunction()
// vtkPiecewiseFunction *GetGrayTransferFunction()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetGrayTransferFunction_1")] public static extern 
bool GetGrayTransferFunction_1(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetScalarOpacity_0(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);

// vtkPiecewiseFunction* GetScalarOpacity()
// vtkPiecewiseFunction *GetScalarOpacity()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetScalarOpacity_1")] public static extern 
bool GetScalarOpacity_1(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetScalarOpacityUnitDistance_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);

// double GetScalarOpacityUnitDistance()
// double GetScalarOpacityUnitDistance()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetScalarOpacityUnitDistance_1")] public static extern 
bool GetScalarOpacityUnitDistance_1(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetTransferFunction2D_0(out IntPtr /*(vtkImageData*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);
...
bool GetTransferFunction2D_1(out IntPtr /*(vtkImageData*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetTransferFunctionModeMinValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetTransferFunctionModeMaxValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetTransferFunctionMode_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetGradientOpacity_0(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);

// vtkPiecewiseFunction* GetGradientOpacity()
// vtkPiecewiseFunction *GetGradientOpacity()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetGradientOpacity_1")] public static extern 
bool GetGradientOpacity_1(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetDisableGradientOpacity_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);
...
bool GetDisableGradientOpacity_1(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetStoredGradientOpacity_0(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);
...
bool GetStoredGradientOpacity_1(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);

// bool HasGradientOpacity(int index = 0)
// bool HasGradientOpacity(int index = 0)
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_HasGradientOpacity_0")] public static extern 
bool HasGradientOpacity_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);
...
bool GetShade_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);

// int GetShade()
// int GetShade()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetShade_1")] public static extern 
bool GetShade_1(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetAmbient_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);

// double GetAmbient()
// double GetAmbient()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetAmbient_1")] public static extern 
bool GetAmbient_1(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetDiffuse_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);

// double GetDiffuse()
// double GetDiffuse()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetDiffuse_1")] public static extern 
bool GetDiffuse_1(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetSpecular_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);

// double GetSpecular()
// double GetSpecular()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetSpecular_1")] public static extern 
bool GetSpecular_1(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
bool GetSpecularPower_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ index);

// double GetSpecularPower()
// double GetSpecularPower()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetSpecularPower_1")] public static extern 
bool GetSpecularPower_1(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
...
// virtual void SetUseClippedVoxelIntensity (int _arg)
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_SetUseClippedVoxelIntensity_0")] public static extern 
bool SetUseClippedVoxelIntensity_0(IntPtr /*(vtkVolumeProperty*)*/ callingObject, int /*(int)*/ _arg);

// virtual int GetUseClippedVoxelIntensity()
// virtual int GetUseClippedVoxelIntensity ()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetUseClippedVoxelIntensity_0")] public static extern 
bool GetUseClippedVoxelIntensity_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);

// virtual void UseClippedVoxelIntensityOn()
// virtual void UseClippedVoxelIntensityOn ()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_UseClippedVoxelIntensityOn_0")] public static extern 
bool UseClippedVoxelIntensityOn_0(IntPtr /*(vtkVolumeProperty*)*/ callingObject);

// virtual void UseClippedVoxelIntensityOff()
// virtual void UseClippedVoxelIntensityOff ()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_UseClippedVoxelIntensityOff_0")] public static extern 
bool UseClippedVoxelIntensityOff_0(IntPtr /*(vtkVolumeProperty*)*/ callingObject);

// virtual void SetClippedVoxelIntensity(double _arg)
// virtual void SetClippedVoxelIntensity (double _arg)
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_SetClippedVoxelIntensity_0")] public static extern 
bool SetClippedVoxelIntensity_0(IntPtr /*(vtkVolumeProperty*)*/ callingObject, double /*(double)*/ _arg);

// virtual double GetClippedVoxelIntensity()
// virtual double GetClippedVoxelIntensity ()
[DllImport("vtkplugin", EntryPoint="vtkVolumeProperty_GetClippedVoxelIntensity_0")] public static extern 
bool GetClippedVoxelIntensity_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolumeProperty*)*/ callingObject);
