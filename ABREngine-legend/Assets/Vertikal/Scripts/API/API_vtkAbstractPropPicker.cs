...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractPropPicker*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAbstractPropPicker*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAbstractPropPicker* NewInstance()
// vtkAbstractPropPicker *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAbstractPropPicker_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAbstractPropPicker*)*/ return_value, IntPtr /*(vtkAbstractPropPicker*)*/ callingObject);
...
bool GetPath_0(out IntPtr /*(vtkAssemblyPath*)*/ return_value, IntPtr /*(vtkAbstractPropPicker*)*/ callingObject);

// virtual vtkProp* GetViewProp()
// virtual vtkProp* GetViewProp()
[DllImport("vtkplugin", EntryPoint="vtkAbstractPropPicker_GetViewProp_0")] public static extern 
bool GetViewProp_0(out IntPtr /*(vtkProp*)*/ return_value, IntPtr /*(vtkAbstractPropPicker*)*/ callingObject);

// virtual vtkProp3D* GetProp3D()
// virtual vtkProp3D *GetProp3D()
[DllImport("vtkplugin", EntryPoint="vtkAbstractPropPicker_GetProp3D_0")] public static extern 
bool GetProp3D_0(out IntPtr /*(vtkProp3D*)*/ return_value, IntPtr /*(vtkAbstractPropPicker*)*/ callingObject);

// virtual vtkActor* GetActor()
// virtual vtkActor *GetActor()
[DllImport("vtkplugin", EntryPoint="vtkAbstractPropPicker_GetActor_0")] public static extern 
bool GetActor_0(out IntPtr /*(vtkActor*)*/ return_value, IntPtr /*(vtkAbstractPropPicker*)*/ callingObject);

// virtual vtkActor2D* GetActor2D()
// virtual vtkActor2D *GetActor2D()
[DllImport("vtkplugin", EntryPoint="vtkAbstractPropPicker_GetActor2D_0")] public static extern 
bool GetActor2D_0(out IntPtr /*(vtkActor2D*)*/ return_value, IntPtr /*(vtkAbstractPropPicker*)*/ callingObject);

// virtual vtkVolume* GetVolume()
// virtual vtkVolume *GetVolume()
[DllImport("vtkplugin", EntryPoint="vtkAbstractPropPicker_GetVolume_0")] public static extern 
bool GetVolume_0(out IntPtr /*(vtkVolume*)*/ return_value, IntPtr /*(vtkAbstractPropPicker*)*/ callingObject);

// virtual vtkAssembly* GetAssembly()
// virtual vtkAssembly *GetAssembly()
[DllImport("vtkplugin", EntryPoint="vtkAbstractPropPicker_GetAssembly_0")] public static extern 
bool GetAssembly_0(out IntPtr /*(vtkAssembly*)*/ return_value, IntPtr /*(vtkAbstractPropPicker*)*/ callingObject);
...
bool GetPropAssembly_0(out IntPtr /*(vtkPropAssembly*)*/ return_value, IntPtr /*(vtkAbstractPropPicker*)*/ callingObject);
