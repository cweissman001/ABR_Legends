...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAssemblyPath*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAssemblyPath*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAssemblyPath* NewInstance()
// vtkAssemblyPath *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAssemblyPath_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAssemblyPath*)*/ return_value, IntPtr /*(vtkAssemblyPath*)*/ callingObject);

// static vtkAssemblyPath* New()
// static vtkAssemblyPath *New()
[DllImport("vtkplugin", EntryPoint="vtkAssemblyPath_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkAssemblyPath*)*/ return_value);
...
bool GetNextNode_0(out IntPtr /*(vtkAssemblyNode*)*/ return_value, IntPtr /*(vtkAssemblyPath*)*/ callingObject);

// vtkAssemblyNode* GetFirstNode()
// vtkAssemblyNode *GetFirstNode()
[DllImport("vtkplugin", EntryPoint="vtkAssemblyPath_GetFirstNode_0")] public static extern 
bool GetFirstNode_0(out IntPtr /*(vtkAssemblyNode*)*/ return_value, IntPtr /*(vtkAssemblyPath*)*/ callingObject);

// vtkAssemblyNode* GetLastNode()
// vtkAssemblyNode *GetLastNode()
[DllImport("vtkplugin", EntryPoint="vtkAssemblyPath_GetLastNode_0")] public static extern 
bool GetLastNode_0(out IntPtr /*(vtkAssemblyNode*)*/ return_value, IntPtr /*(vtkAssemblyPath*)*/ callingObject);
...
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkAssemblyPath*)*/ callingObject);
