...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkShaderDeviceAdapter2*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkShaderDeviceAdapter2*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);
...
bool NewInstance_0(out IntPtr /*(vtkShaderDeviceAdapter2*)*/ return_value, IntPtr /*(vtkShaderDeviceAdapter2*)*/ callingObject);
