...
bool New_0(out IntPtr /*(vtkAssemblyPaths*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAssemblyPaths*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAssemblyPaths*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAssemblyPaths* NewInstance()
// vtkAssemblyPaths *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAssemblyPaths_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAssemblyPaths*)*/ return_value, IntPtr /*(vtkAssemblyPaths*)*/ callingObject);
...
bool IsItemPresent_0(out int /*(int)*/ return_value, IntPtr /*(vtkAssemblyPaths*)*/ callingObject, IntPtr /*(vtkAssemblyPath*)*/ p);

// vtkAssemblyPath* GetNextItem()
// vtkAssemblyPath *GetNextItem()
[DllImport("vtkplugin", EntryPoint="vtkAssemblyPaths_GetNextItem_0")] public static extern 
bool GetNextItem_0(out IntPtr /*(vtkAssemblyPath*)*/ return_value, IntPtr /*(vtkAssemblyPaths*)*/ callingObject);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkAssemblyPaths_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkAssemblyPaths*)*/ callingObject);
