...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkXMLUnstructuredDataReader*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkXMLUnstructuredDataReader*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);
...
bool NewInstance_0(out IntPtr /*(vtkXMLUnstructuredDataReader*)*/ return_value, IntPtr /*(vtkXMLUnstructuredDataReader*)*/ callingObject);

// vtkIdType GetNumberOfPoints()
// vtkIdType GetNumberOfPoints()
[DllImport("vtkplugin", EntryPoint="vtkXMLUnstructuredDataReader_GetNumberOfPoints_0")] public static extern 
bool GetNumberOfPoints_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkXMLUnstructuredDataReader*)*/ callingObject);

// vtkIdType GetNumberOfCells()
// vtkIdType GetNumberOfCells()
[DllImport("vtkplugin", EntryPoint="vtkXMLUnstructuredDataReader_GetNumberOfCells_0")] public static extern 
bool GetNumberOfCells_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkXMLUnstructuredDataReader*)*/ callingObject);
...
bool GetNumberOfPieces_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkXMLUnstructuredDataReader*)*/ callingObject);
