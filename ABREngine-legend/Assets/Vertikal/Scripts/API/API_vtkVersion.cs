...
bool New_0(out IntPtr /*(vtkVersion*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkVersion*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkVersion*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkVersion* NewInstance()
// vtkVersion *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkVersion_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkVersion*)*/ return_value, IntPtr /*(vtkVersion*)*/ callingObject);
...
bool GetVTKSourceVersion_0(out byte[] /*(char*)*/ return_value);
