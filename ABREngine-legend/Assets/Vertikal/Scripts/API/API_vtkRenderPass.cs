...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkRenderPass*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkRenderPass*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkRenderPass* NewInstance()
// vtkRenderPass *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkRenderPass_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkRenderPass*)*/ return_value, IntPtr /*(vtkRenderPass*)*/ callingObject);
...
bool GetNumberOfRenderedProps_0(out int /*(int)*/ return_value, IntPtr /*(vtkRenderPass*)*/ callingObject);
