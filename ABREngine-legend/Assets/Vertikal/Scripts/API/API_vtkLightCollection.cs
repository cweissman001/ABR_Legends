...
bool New_0(out IntPtr /*(vtkLightCollection*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkLightCollection*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkLightCollection*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkLightCollection* NewInstance()
// vtkLightCollection *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkLightCollection_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkLightCollection*)*/ return_value, IntPtr /*(vtkLightCollection*)*/ callingObject);
...
bool GetNextItem_0(out IntPtr /*(vtkLight*)*/ return_value, IntPtr /*(vtkLightCollection*)*/ callingObject);
