...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAbstractPointLocator*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);
...
bool NewInstance_0(out IntPtr /*(vtkAbstractPointLocator*)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject);
...
bool FindClosestPoint_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, double /*(double[3])*/ []x);

// vtkIdType FindClosestPoint(double x, double y, double z)
// vtkIdType FindClosestPoint(double x, double y, double z)
[DllImport("vtkplugin", EntryPoint="vtkAbstractPointLocator_FindClosestPoint_1")] public static extern 
bool FindClosestPoint_1(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool FindClosestPointWithinRadius_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, double /*(double)*/ radius, double /*(double[3])*/ []x, IntPtr /*(double&)*/ dist2);
...
bool GetBounds_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject);
...
bool GetBounds_1(IntPtr /*(vtkAbstractPointLocator*)*/ callingObject, double[] /*(double*)*/ ARG_0);
...
bool GetNumberOfBuckets_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkAbstractPointLocator*)*/ callingObject);
