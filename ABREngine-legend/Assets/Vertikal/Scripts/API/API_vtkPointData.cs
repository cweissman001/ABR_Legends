...
bool New_0(out IntPtr /*(vtkPointData*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPointData*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPointData*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkPointData* NewInstance()
// vtkPointData *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkPointData_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkPointData*)*/ return_value, IntPtr /*(vtkPointData*)*/ callingObject);
