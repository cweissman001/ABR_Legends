...
bool New_0(out IntPtr /*(vtkIdList*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkIdList*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkIdList* NewInstance()
// vtkIdList *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkIdList_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkIdList*)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject);
...
bool Allocate_0(out int /*(int)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject, long /*(vtkIdType)*/ sz, int /*(int)*/ strategy);

// vtkIdType GetNumberOfIds()
// vtkIdType GetNumberOfIds()
[DllImport("vtkplugin", EntryPoint="vtkIdList_GetNumberOfIds_0")] public static extern 
bool GetNumberOfIds_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject);

// vtkIdType GetId(const vtkIdType i)
// vtkIdType GetId(const vtkIdType i)
[DllImport("vtkplugin", EntryPoint="vtkIdList_GetId_0")] public static extern 
bool GetId_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject, long /*(vtkIdType)*/ i);
...
bool InsertNextId_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject, long /*(vtkIdType)*/ vtkid);
...
bool InsertUniqueId_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject, long /*(vtkIdType)*/ vtkid);

// void Sort()
// void Sort()
[DllImport("vtkplugin", EntryPoint="vtkIdList_Sort_0")] public static extern 
bool Sort_0(IntPtr /*(vtkIdList*)*/ callingObject);

// vtkIdType* GetPointer(const vtkIdType i)
// vtkIdType *GetPointer(const vtkIdType i)
[DllImport("vtkplugin", EntryPoint="vtkIdList_GetPointer_0")] public static extern 
bool GetPointer_0(out long[] /*(vtkIdType*)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject, long /*(vtkIdType)*/ i);
...
bool WritePointer_0(out long[] /*(vtkIdType*)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject, long /*(vtkIdType)*/ i, long /*(vtkIdType)*/ number);

// void SetArray(vtkIdType * array, vtkIdType size)
// void SetArray(vtkIdType *array, vtkIdType size)
[DllImport("vtkplugin", EntryPoint="vtkIdList_SetArray_0")] public static extern 
bool SetArray_0(IntPtr /*(vtkIdList*)*/ callingObject, long[] /*(vtkIdType*)*/ array, long /*(vtkIdType)*/ size);
...
bool IsId_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject, long /*(vtkIdType)*/ vtkid);
...
bool Resize_0(out long[] /*(vtkIdType*)*/ return_value, IntPtr /*(vtkIdList*)*/ callingObject, long /*(vtkIdType)*/ sz);
