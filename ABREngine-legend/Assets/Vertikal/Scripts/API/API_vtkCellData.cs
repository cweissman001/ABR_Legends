...
bool New_0(out IntPtr /*(vtkCellData*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkCellData*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkCellData*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkCellData* NewInstance()
// vtkCellData *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkCellData_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkCellData*)*/ return_value, IntPtr /*(vtkCellData*)*/ callingObject);
