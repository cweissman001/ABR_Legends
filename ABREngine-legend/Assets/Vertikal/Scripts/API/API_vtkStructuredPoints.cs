...
bool New_0(out IntPtr /*(vtkStructuredPoints*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkStructuredPoints*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkStructuredPoints*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkStructuredPoints* NewInstance()
// vtkStructuredPoints *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkStructuredPoints_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkStructuredPoints*)*/ return_value, IntPtr /*(vtkStructuredPoints*)*/ callingObject);

// int GetDataObjectType()
// int GetDataObjectType()
[DllImport("vtkplugin", EntryPoint="vtkStructuredPoints_GetDataObjectType_0")] public static extern 
bool GetDataObjectType_0(out int /*(int)*/ return_value, IntPtr /*(vtkStructuredPoints*)*/ callingObject);
