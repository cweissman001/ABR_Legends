...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkXMLDataParser*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkXMLDataParser* NewInstance()
// vtkXMLDataParser *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkXMLDataParser_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkXMLDataParser*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);

// static vtkXMLDataParser* New()
// static vtkXMLDataParser* New()
[DllImport("vtkplugin", EntryPoint="vtkXMLDataParser_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkXMLDataParser*)*/ return_value);

// vtkXMLDataElement* GetRootElement()
// vtkXMLDataElement* GetRootElement()
[DllImport("vtkplugin", EntryPoint="vtkXMLDataParser_GetRootElement_0")] public static extern 
bool GetRootElement_0(out IntPtr /*(vtkXMLDataElement*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);
...
bool ReadInlineData_0(out ulong /*(size_t)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, IntPtr /*(vtkXMLDataElement*)*/ element, int /*(int)*/ isAscii, IntPtr /*(void*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ numWords, int /*(int)*/ wordType);
...
bool ReadInlineData_1(out ulong /*(size_t)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, IntPtr /*(vtkXMLDataElement*)*/ element, int /*(int)*/ isAscii, string /*(char*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ numWords);
...
bool ReadAppendedData_0(out ulong /*(size_t)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, long /*(vtkTypeInt64)*/ offset, IntPtr /*(void*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ numWords, int /*(int)*/ wordType);
...
bool ReadAppendedData_1(out ulong /*(size_t)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, long /*(vtkTypeInt64)*/ offset, string /*(char*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ numWords);
...
bool ReadAsciiData_0(out ulong /*(size_t)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, IntPtr /*(void*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ numWords, int /*(int)*/ wordType);
...
bool ReadBinaryData_0(out ulong /*(size_t)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, IntPtr /*(void*)*/ buffer, ulong /*(vtkTypeUInt64)*/ startWord, ulong /*(size_t)*/ maxWords, int /*(int)*/ wordType);
...
bool GetCompressor_0(out IntPtr /*(vtkDataCompressor*)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);
...
bool GetWordTypeSize_0(out ulong /*(size_t)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject, int /*(int)*/ wordType);

// int Parse()
// int Parse()
[DllImport("vtkplugin", EntryPoint="vtkXMLDataParser_Parse_0")] public static extern 
bool Parse_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);

// virtual int GetAbort()
// virtual int GetAbort ()
[DllImport("vtkplugin", EntryPoint="vtkXMLDataParser_GetAbort_0")] public static extern 
bool GetAbort_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);
...
bool GetProgress_0(out float /*(float)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);
...
bool GetAttributesEncodingMinValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);
...
bool GetAttributesEncodingMaxValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);
...
bool GetAttributesEncoding_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);
...
bool GetAppendedDataPosition_0(out long /*(vtkTypeInt64)*/ return_value, IntPtr /*(vtkXMLDataParser*)*/ callingObject);
