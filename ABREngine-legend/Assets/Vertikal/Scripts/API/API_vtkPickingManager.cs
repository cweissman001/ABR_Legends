...
bool New_0(out IntPtr /*(vtkPickingManager*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPickingManager*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkPickingManager* NewInstance()
// vtkPickingManager *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkPickingManager_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkPickingManager*)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject);
...
bool GetEnabled_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject);
...
bool GetOptimizeOnInteractorEvents_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject);
...
bool GetInteractor_0(out IntPtr /*(vtkRenderWindowInteractor*)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject);

// void AddPicker(vtkAbstractPicker * picker, vtkObject * object = nullptr)
// void AddPicker(vtkAbstractPicker* picker, vtkObject* object = nullptr)
[DllImport("vtkplugin", EntryPoint="vtkPickingManager_AddPicker_0")] public static extern 
bool AddPicker_0(IntPtr /*(vtkPickingManager*)*/ callingObject, IntPtr /*(vtkAbstractPicker*)*/ picker, IntPtr /*(vtkObject*)*/ obj);

// void RemovePicker(vtkAbstractPicker * picker, vtkObject * object = nullptr)
// void RemovePicker(vtkAbstractPicker* picker, vtkObject* object = nullptr)
[DllImport("vtkplugin", EntryPoint="vtkPickingManager_RemovePicker_0")] public static extern 
bool RemovePicker_0(IntPtr /*(vtkPickingManager*)*/ callingObject, IntPtr /*(vtkAbstractPicker*)*/ picker, IntPtr /*(vtkObject*)*/ obj);
...
bool Pick_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject, IntPtr /*(vtkAbstractPicker*)*/ picker, IntPtr /*(vtkObject*)*/ obj);

// bool Pick(vtkObject * object)
// bool Pick(vtkObject* object)
[DllImport("vtkplugin", EntryPoint="vtkPickingManager_Pick_1")] public static extern 
bool Pick_1(out bool /*(bool)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject, IntPtr /*(vtkObject*)*/ obj);

// bool Pick(vtkAbstractPicker * picker)
// bool Pick(vtkAbstractPicker* picker)
[DllImport("vtkplugin", EntryPoint="vtkPickingManager_Pick_2")] public static extern 
bool Pick_2(out bool /*(bool)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject, IntPtr /*(vtkAbstractPicker*)*/ picker);
...
bool GetAssemblyPath_0(out IntPtr /*(vtkAssemblyPath*)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject, double /*(double)*/ X, double /*(double)*/ Y, double /*(double)*/ Z, IntPtr /*(vtkAbstractPropPicker*)*/ picker, IntPtr /*(vtkRenderer*)*/ renderer, IntPtr /*(vtkObject*)*/ obj);

// int GetNumberOfPickers()
// int GetNumberOfPickers()
[DllImport("vtkplugin", EntryPoint="vtkPickingManager_GetNumberOfPickers_0")] public static extern 
bool GetNumberOfPickers_0(out int /*(int)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject);
...
bool GetNumberOfObjectsLinked_0(out int /*(int)*/ return_value, IntPtr /*(vtkPickingManager*)*/ callingObject, IntPtr /*(vtkAbstractPicker*)*/ picker);
