...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject, string /*(char*)*/ type);

// static vtkActor* SafeDownCast(vtkObjectBase * o)
// static vtkActor* SafeDownCast(vtkObjectBase *o)
[DllImport("vtkplugin", EntryPoint="vtkActor_SafeDownCast_0")] public static extern 
bool SafeDownCast_0(out IntPtr /*(vtkActor*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkActor* NewInstance()
// vtkActor *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkActor_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkActor*)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);

// static vtkActor* New()
// static vtkActor *New()
[DllImport("vtkplugin", EntryPoint="vtkActor_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkActor*)*/ return_value);
...
bool RenderOpaqueGeometry_0(out int /*(int)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject, IntPtr /*(vtkViewport*)*/ viewport);
...
bool RenderTranslucentPolygonalGeometry_0(out int /*(int)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject, IntPtr /*(vtkViewport*)*/ viewport);
...
bool HasTranslucentPolygonalGeometry_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);
...
bool GetProperty_0(out IntPtr /*(vtkProperty*)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);

// virtual vtkProperty* MakeProperty()
// virtual vtkProperty* MakeProperty()
[DllImport("vtkplugin", EntryPoint="vtkActor_MakeProperty_0")] public static extern 
bool MakeProperty_0(out IntPtr /*(vtkProperty*)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);
...
bool GetBackfaceProperty_0(out IntPtr /*(vtkProperty*)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);
...
bool GetTexture_0(out IntPtr /*(vtkTexture*)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);
...
bool GetMapper_0(out IntPtr /*(vtkMapper*)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);

// double* GetBounds()
// double *GetBounds()
[DllImport("vtkplugin", EntryPoint="vtkActor_GetBounds_0")] public static extern 
bool GetBounds_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);
...
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);

// vtkMTimeType GetRedrawMTime()
// vtkMTimeType GetRedrawMTime()
[DllImport("vtkplugin", EntryPoint="vtkActor_GetRedrawMTime_0")] public static extern 
bool GetRedrawMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);

// virtual bool GetForceOpaque()
// virtual bool GetForceOpaque ()
[DllImport("vtkplugin", EntryPoint="vtkActor_GetForceOpaque_0")] public static extern 
bool GetForceOpaque_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);
...
bool GetForceTranslucent_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);
...
bool GetSupportsSelection_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkActor*)*/ callingObject);
