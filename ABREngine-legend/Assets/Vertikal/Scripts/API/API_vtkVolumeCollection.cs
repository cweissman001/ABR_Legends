...
bool New_0(out IntPtr /*(vtkVolumeCollection*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkVolumeCollection*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkVolumeCollection*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkVolumeCollection* NewInstance()
// vtkVolumeCollection *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkVolumeCollection_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkVolumeCollection*)*/ return_value, IntPtr /*(vtkVolumeCollection*)*/ callingObject);
...
bool GetNextVolume_0(out IntPtr /*(vtkVolume*)*/ return_value, IntPtr /*(vtkVolumeCollection*)*/ callingObject);

// vtkVolume* GetNextItem()
// vtkVolume *GetNextItem()
[DllImport("vtkplugin", EntryPoint="vtkVolumeCollection_GetNextItem_0")] public static extern 
bool GetNextItem_0(out IntPtr /*(vtkVolume*)*/ return_value, IntPtr /*(vtkVolumeCollection*)*/ callingObject);
