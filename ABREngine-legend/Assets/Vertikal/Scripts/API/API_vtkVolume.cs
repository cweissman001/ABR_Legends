...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkVolume*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkVolume* NewInstance()
// vtkVolume *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkVolume_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkVolume*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);

// static vtkVolume* New()
// static vtkVolume *New()
[DllImport("vtkplugin", EntryPoint="vtkVolume_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkVolume*)*/ return_value);
...
bool GetMapper_0(out IntPtr /*(vtkAbstractVolumeMapper*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
...
bool GetProperty_0(out IntPtr /*(vtkVolumeProperty*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
...
bool GetBounds_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
...
bool GetMinXBound_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);

// double GetMaxXBound()
// double GetMaxXBound()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetMaxXBound_0")] public static extern 
bool GetMaxXBound_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);

// double GetMinYBound()
// double GetMinYBound()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetMinYBound_0")] public static extern 
bool GetMinYBound_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);

// double GetMaxYBound()
// double GetMaxYBound()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetMaxYBound_0")] public static extern 
bool GetMaxYBound_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);

// double GetMinZBound()
// double GetMinZBound()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetMinZBound_0")] public static extern 
bool GetMinZBound_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);

// double GetMaxZBound()
// double GetMaxZBound()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetMaxZBound_0")] public static extern 
bool GetMaxZBound_0(out double /*(double)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);

// vtkMTimeType GetRedrawMTime()
// vtkMTimeType GetRedrawMTime()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetRedrawMTime_0")] public static extern 
bool GetRedrawMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
...
bool RenderVolumetricGeometry_0(out int /*(int)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject, IntPtr /*(vtkViewport*)*/ viewport);
...
bool GetCorrectedScalarOpacityArray_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject, int /*(int)*/ ARG_0);
...
bool GetCorrectedScalarOpacityArray_1(out float[] /*(float*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
...
bool GetScalarOpacityArray_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject, int /*(int)*/ ARG_0);

// float* GetScalarOpacityArray()
// float *GetScalarOpacityArray()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetScalarOpacityArray_1")] public static extern 
bool GetScalarOpacityArray_1(out float[] /*(float*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
...
bool GetGradientOpacityArray_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject, int /*(int)*/ ARG_0);

// float* GetGradientOpacityArray()
// float *GetGradientOpacityArray()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetGradientOpacityArray_1")] public static extern 
bool GetGradientOpacityArray_1(out float[] /*(float*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
...
bool GetGrayArray_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject, int /*(int)*/ ARG_0);

// float* GetGrayArray()
// float *GetGrayArray()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetGrayArray_1")] public static extern 
bool GetGrayArray_1(out float[] /*(float*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
...
bool GetRGBArray_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject, int /*(int)*/ ARG_0);

// float* GetRGBArray()
// float *GetRGBArray()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetRGBArray_1")] public static extern 
bool GetRGBArray_1(out float[] /*(float*)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
...
bool GetGradientOpacityConstant_0(out float /*(float)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject, int /*(int)*/ ARG_0);
...
bool GetGradientOpacityConstant_1(out float /*(float)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);

// float GetArraySize()
// float GetArraySize()
[DllImport("vtkplugin", EntryPoint="vtkVolume_GetArraySize_0")] public static extern 
bool GetArraySize_0(out float /*(float)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
...
bool GetSupportsSelection_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkVolume*)*/ callingObject);
