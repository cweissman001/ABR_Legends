...
bool Set_0(IntPtr /*(vtkInformationDoubleVectorKey*)*/ callingObject, IntPtr /*(vtkInformation*)*/ info, double[] /*(double*)*/ value, int /*(int)*/ length);
...
bool Get_2(IntPtr /*(vtkInformationDoubleVectorKey*)*/ callingObject, IntPtr /*(vtkInformation*)*/ info, double[] /*(double*)*/ value);
