...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkArrayIterator*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkArrayIterator*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkArrayIterator* NewInstance()
// vtkArrayIterator *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkArrayIterator_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkArrayIterator*)*/ return_value, IntPtr /*(vtkArrayIterator*)*/ callingObject);
...
bool GetDataType_0(out int /*(int)*/ return_value, IntPtr /*(vtkArrayIterator*)*/ callingObject);
