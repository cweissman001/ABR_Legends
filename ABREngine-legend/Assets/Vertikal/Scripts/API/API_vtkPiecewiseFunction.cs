...
bool New_0(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkPiecewiseFunction* NewInstance()
// vtkPiecewiseFunction *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkPiecewiseFunction_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkPiecewiseFunction*)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject);
...
bool GetDataObjectType_0(out int /*(int)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject);

// int GetSize()
// int GetSize()
[DllImport("vtkplugin", EntryPoint="vtkPiecewiseFunction_GetSize_0")] public static extern 
bool GetSize_0(out int /*(int)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject);

// int AddPoint(double x, double y)
// int AddPoint( double x, double y )
[DllImport("vtkplugin", EntryPoint="vtkPiecewiseFunction_AddPoint_0")] public static extern 
bool AddPoint_0(out int /*(int)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y);
...
bool AddPoint_1(out int /*(int)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ midpoint, double /*(double)*/ sharpness);

// int RemovePoint(double x)
// int RemovePoint( double x )
[DllImport("vtkplugin", EntryPoint="vtkPiecewiseFunction_RemovePoint_0")] public static extern 
bool RemovePoint_0(out int /*(int)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, double /*(double)*/ x);
...
bool GetValue_0(out double /*(double)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, double /*(double)*/ x);
...
bool GetNodeValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, int /*(int)*/ index, double /*(double[4])*/ []val);
...
bool SetNodeValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, int /*(int)*/ index, double /*(double[4])*/ []val);

// double* GetDataPointer()
// double *GetDataPointer()
[DllImport("vtkplugin", EntryPoint="vtkPiecewiseFunction_GetDataPointer_0")] public static extern 
bool GetDataPointer_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject);
...
bool FillFromDataPointer_0(IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, int /*(int)*/ ARG_0, double[] /*(double*)*/ ARG_1);

// virtual double* GetRange()
// virtual double *GetRange ()
[DllImport("vtkplugin", EntryPoint="vtkPiecewiseFunction_GetRange_0")] public static extern 
bool GetRange_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject);
...
bool AdjustRange_0(out int /*(int)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, double /*(double[2])*/ []range);
...
bool GetTable_0(IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, double /*(double)*/ x1, double /*(double)*/ x2, int /*(int)*/ size, float[] /*(float*)*/ table, int /*(int)*/ stride, int /*(int)*/ logIncrements);
...
bool GetTable_1(IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, double /*(double)*/ x1, double /*(double)*/ x2, int /*(int)*/ size, double[] /*(double*)*/ table, int /*(int)*/ stride, int /*(int)*/ logIncrements);
...
bool BuildFunctionFromTable_0(IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, double /*(double)*/ x1, double /*(double)*/ x2, int /*(int)*/ size, double[] /*(double*)*/ table, int /*(int)*/ stride);
...
bool SetClamping_0(IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);

// virtual vtkTypeBool GetClamping()
// virtual vtkTypeBool GetClamping ()
[DllImport("vtkplugin", EntryPoint="vtkPiecewiseFunction_GetClamping_0")] public static extern 
bool GetClamping_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject);
...
bool GetUseLogScale_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject);
...
bool GetType_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject);
...
bool GetFirstNonZeroValue_0(out double /*(double)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject);
...
bool SetAllowDuplicateScalars_0(IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetAllowDuplicateScalars_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject);
...
bool EstimateMinNumberOfSamples_0(out int /*(int)*/ return_value, IntPtr /*(vtkPiecewiseFunction*)*/ callingObject, IntPtr /*(doubleconst&)*/ x1, IntPtr /*(doubleconst&)*/ x2);
