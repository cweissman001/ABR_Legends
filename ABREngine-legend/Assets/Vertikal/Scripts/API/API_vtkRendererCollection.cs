...
bool New_0(out IntPtr /*(vtkRendererCollection*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkRendererCollection*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkRendererCollection*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkRendererCollection* NewInstance()
// vtkRendererCollection *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkRendererCollection_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkRendererCollection*)*/ return_value, IntPtr /*(vtkRendererCollection*)*/ callingObject);
...
bool GetNextItem_0(out IntPtr /*(vtkRenderer*)*/ return_value, IntPtr /*(vtkRendererCollection*)*/ callingObject);
...
bool GetFirstRenderer_0(out IntPtr /*(vtkRenderer*)*/ return_value, IntPtr /*(vtkRendererCollection*)*/ callingObject);
