...
bool New_0(out IntPtr /*(vtkAssemblyNode*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAssemblyNode*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAssemblyNode*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAssemblyNode* NewInstance()
// vtkAssemblyNode *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAssemblyNode_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAssemblyNode*)*/ return_value, IntPtr /*(vtkAssemblyNode*)*/ callingObject);
...
bool GetViewProp_0(out IntPtr /*(vtkProp*)*/ return_value, IntPtr /*(vtkAssemblyNode*)*/ callingObject);
...
bool GetMatrix_0(out IntPtr /*(vtkMatrix4x4*)*/ return_value, IntPtr /*(vtkAssemblyNode*)*/ callingObject);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkAssemblyNode_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkAssemblyNode*)*/ callingObject);
