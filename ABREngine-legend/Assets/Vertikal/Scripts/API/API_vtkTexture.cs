...
bool New_0(out IntPtr /*(vtkTexture*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkTexture*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkTexture* NewInstance()
// vtkTexture *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkTexture_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkTexture*)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool GetRepeat_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);

// virtual void SetRepeat(vtkTypeBool _arg)
// virtual void SetRepeat (vtkTypeBool _arg)
[DllImport("vtkplugin", EntryPoint="vtkTexture_SetRepeat_0")] public static extern 
bool SetRepeat_0(IntPtr /*(vtkTexture*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetEdgeClamp_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);

// virtual void SetEdgeClamp(vtkTypeBool _arg)
// virtual void SetEdgeClamp (vtkTypeBool _arg)
[DllImport("vtkplugin", EntryPoint="vtkTexture_SetEdgeClamp_0")] public static extern 
bool SetEdgeClamp_0(IntPtr /*(vtkTexture*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetInterpolate_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool SetInterpolate_0(IntPtr /*(vtkTexture*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetMipmap_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool GetQuality_0(out int /*(int)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool GetColorMode_0(out int /*(int)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool GetInput_0(out IntPtr /*(vtkImageData*)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool GetLookupTable_0(out IntPtr /*(vtkScalarsToColors*)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool GetMappedScalars_0(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool MapScalarsToColors_0(out byte[] /*(unsigned char*)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject, IntPtr /*(vtkDataArray*)*/ scalars);
...
bool GetTransform_0(out IntPtr /*(vtkTransform*)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);

// virtual int GetBlendingMode()
// virtual int GetBlendingMode ()
[DllImport("vtkplugin", EntryPoint="vtkTexture_GetBlendingMode_0")] public static extern 
bool GetBlendingMode_0(out int /*(int)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool GetPremultipliedAlpha_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool GetRestrictPowerOf2ImageSmaller_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool SetRestrictPowerOf2ImageSmaller_0(IntPtr /*(vtkTexture*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool IsTranslucent_0(out int /*(int)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);

// virtual int GetTextureUnit()
// virtual int GetTextureUnit()
[DllImport("vtkplugin", EntryPoint="vtkTexture_GetTextureUnit_0")] public static extern 
bool GetTextureUnit_0(out int /*(int)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);

// virtual bool GetCubeMap()
// virtual bool GetCubeMap ()
[DllImport("vtkplugin", EntryPoint="vtkTexture_GetCubeMap_0")] public static extern 
bool GetCubeMap_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
...
bool GetUseSRGBColorSpace_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkTexture*)*/ callingObject);
