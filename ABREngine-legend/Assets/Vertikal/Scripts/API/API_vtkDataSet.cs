...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkDataSet*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkDataSet* NewInstance()
// vtkDataSet *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkDataSet*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);
...
bool GetNumberOfPoints_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// virtual vtkIdType GetNumberOfCells()
// virtual vtkIdType GetNumberOfCells()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetNumberOfCells_0")] public static extern 
bool GetNumberOfCells_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// virtual double* GetPoint(vtkIdType ptId)
// virtual double *GetPoint(vtkIdType ptId)
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetPoint_0")] public static extern 
bool GetPoint_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, long /*(vtkIdType)*/ ptId);
...
bool NewCellIterator_0(out IntPtr /*(vtkCellIterator*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// virtual vtkCell* GetCell(vtkIdType cellId)
// virtual vtkCell *GetCell(vtkIdType cellId)
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetCell_0")] public static extern 
bool GetCell_0(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, long /*(vtkIdType)*/ cellId);
...
bool GetCell_1(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, int /*(int)*/ ARG_0, int /*(int)*/ ARG_1, int /*(int)*/ ARG_2);
...
bool GetCellType_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, long /*(vtkIdType)*/ cellId);
...
bool FindPoint_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);

// virtual vtkIdType FindPoint(double x[3])
// virtual vtkIdType FindPoint(double x[3])
[DllImport("vtkplugin", EntryPoint="vtkDataSet_FindPoint_1")] public static extern 
bool FindPoint_1(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, double /*(double[3])*/ []x);

// virtual vtkIdType FindCell(double x[3], vtkCell * cell, vtkIdType cellId, double tol2, int & subId, double pcoords[3], double * weights)
// virtual vtkIdType FindCell(double x[3], vtkCell *cell, vtkIdType cellId, double tol2, int& subId, double pcoords[3], double *weights)
[DllImport("vtkplugin", EntryPoint="vtkDataSet_FindCell_0")] public static extern 
bool FindCell_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, double /*(double[3])*/ []x, IntPtr /*(vtkCell*)*/ cell, long /*(vtkIdType)*/ cellId, double /*(double)*/ tol2, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, double[] /*(double*)*/ weights);

// virtual vtkIdType FindCell(double x[3], vtkCell * cell, vtkGenericCell * gencell, vtkIdType cellId, double tol2, int & subId, double pcoords[3], double * weights)
// virtual vtkIdType FindCell(double x[3], vtkCell *cell, vtkGenericCell *gencell, vtkIdType cellId, double tol2, int& subId, double pcoords[3], double *weights)
[DllImport("vtkplugin", EntryPoint="vtkDataSet_FindCell_1")] public static extern 
bool FindCell_1(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, double /*(double[3])*/ []x, IntPtr /*(vtkCell*)*/ cell, IntPtr /*(vtkGenericCell*)*/ gencell, long /*(vtkIdType)*/ cellId, double /*(double)*/ tol2, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, double[] /*(double*)*/ weights);

// virtual vtkCell* FindAndGetCell(double x[3], vtkCell * cell, vtkIdType cellId, double tol2, int & subId, double pcoords[3], double * weights)
// virtual vtkCell *FindAndGetCell(double x[3], vtkCell *cell, vtkIdType cellId, double tol2, int& subId, double pcoords[3], double *weights)
[DllImport("vtkplugin", EntryPoint="vtkDataSet_FindAndGetCell_0")] public static extern 
bool FindAndGetCell_0(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, double /*(double[3])*/ []x, IntPtr /*(vtkCell*)*/ cell, long /*(vtkIdType)*/ cellId, double /*(double)*/ tol2, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, double[] /*(double*)*/ weights);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// vtkCellData* GetCellData()
// vtkCellData *GetCellData()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetCellData_0")] public static extern 
bool GetCellData_0(out IntPtr /*(vtkCellData*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// vtkPointData* GetPointData()
// vtkPointData *GetPointData()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetPointData_0")] public static extern 
bool GetPointData_0(out IntPtr /*(vtkPointData*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);
...
bool GetBounds_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);
...
bool GetCenter_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);
...
bool GetLength_0(out double /*(double)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);
...
bool GetScalarRange_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// virtual int GetMaxCellSize()
// virtual int GetMaxCellSize()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetMaxCellSize_0")] public static extern 
bool GetMaxCellSize_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// long GetActualMemorySize()
// unsigned long GetActualMemorySize()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetActualMemorySize_0")] public static extern 
bool GetActualMemorySize_0(out ulong /*(unsigned long)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// int GetDataObjectType()
// int GetDataObjectType()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetDataObjectType_0")] public static extern 
bool GetDataObjectType_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);
...
bool CheckAttributes_0(out int /*(int)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);
...
bool GetAttributesAsFieldData_0(out IntPtr /*(vtkFieldData*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, int /*(int)*/ type);
...
bool GetNumberOfElements_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject, int /*(int)*/ type);

// bool HasAnyGhostCells()
// bool HasAnyGhostCells()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_HasAnyGhostCells_0")] public static extern 
bool HasAnyGhostCells_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// bool HasAnyGhostPoints()
// bool HasAnyGhostPoints()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_HasAnyGhostPoints_0")] public static extern 
bool HasAnyGhostPoints_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// virtual bool HasAnyBlankCells()
// virtual bool HasAnyBlankCells()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_HasAnyBlankCells_0")] public static extern 
bool HasAnyBlankCells_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// virtual bool HasAnyBlankPoints()
// virtual bool HasAnyBlankPoints()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_HasAnyBlankPoints_0")] public static extern 
bool HasAnyBlankPoints_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// vtkUnsignedCharArray* GetPointGhostArray()
// vtkUnsignedCharArray* GetPointGhostArray()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetPointGhostArray_0")] public static extern 
bool GetPointGhostArray_0(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);
...
bool AllocatePointGhostArray_0(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);

// vtkUnsignedCharArray* GetCellGhostArray()
// vtkUnsignedCharArray* GetCellGhostArray()
[DllImport("vtkplugin", EntryPoint="vtkDataSet_GetCellGhostArray_0")] public static extern 
bool GetCellGhostArray_0(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);
...
bool AllocateCellGhostArray_0(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value, IntPtr /*(vtkDataSet*)*/ callingObject);
