...
bool New_0(out IntPtr /*(vtkUnstructuredGridAlgorithm*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkUnstructuredGridAlgorithm*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkUnstructuredGridAlgorithm*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);
...
bool NewInstance_0(out IntPtr /*(vtkUnstructuredGridAlgorithm*)*/ return_value, IntPtr /*(vtkUnstructuredGridAlgorithm*)*/ callingObject);

// vtkUnstructuredGrid* GetOutput()
// vtkUnstructuredGrid* GetOutput()
[DllImport("vtkplugin", EntryPoint="vtkUnstructuredGridAlgorithm_GetOutput_0")] public static extern 
bool GetOutput_0(out IntPtr /*(vtkUnstructuredGrid*)*/ return_value, IntPtr /*(vtkUnstructuredGridAlgorithm*)*/ callingObject);
...
bool GetOutput_1(out IntPtr /*(vtkUnstructuredGrid*)*/ return_value, IntPtr /*(vtkUnstructuredGridAlgorithm*)*/ callingObject, int /*(int)*/ ARG_0);
...
bool GetInput_0(out IntPtr /*(vtkDataObject*)*/ return_value, IntPtr /*(vtkUnstructuredGridAlgorithm*)*/ callingObject, int /*(int)*/ port);

// vtkDataObject* GetInput()
// vtkDataObject *GetInput()
[DllImport("vtkplugin", EntryPoint="vtkUnstructuredGridAlgorithm_GetInput_1")] public static extern 
bool GetInput_1(out IntPtr /*(vtkDataObject*)*/ return_value, IntPtr /*(vtkUnstructuredGridAlgorithm*)*/ callingObject);
...
bool GetUnstructuredGridInput_0(out IntPtr /*(vtkUnstructuredGrid*)*/ return_value, IntPtr /*(vtkUnstructuredGridAlgorithm*)*/ callingObject, int /*(int)*/ port);
