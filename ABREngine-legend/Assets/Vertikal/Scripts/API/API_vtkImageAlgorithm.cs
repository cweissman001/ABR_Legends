...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkImageAlgorithm*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkImageAlgorithm*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkImageAlgorithm* NewInstance()
// vtkImageAlgorithm *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkImageAlgorithm_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkImageAlgorithm*)*/ return_value, IntPtr /*(vtkImageAlgorithm*)*/ callingObject);

// vtkImageData* GetOutput()
// vtkImageData* GetOutput()
[DllImport("vtkplugin", EntryPoint="vtkImageAlgorithm_GetOutput_0")] public static extern 
bool GetOutput_0(out IntPtr /*(vtkImageData*)*/ return_value, IntPtr /*(vtkImageAlgorithm*)*/ callingObject);

// vtkImageData* GetOutput(int ARG_0)
// vtkImageData* GetOutput(int)
[DllImport("vtkplugin", EntryPoint="vtkImageAlgorithm_GetOutput_1")] public static extern 
bool GetOutput_1(out IntPtr /*(vtkImageData*)*/ return_value, IntPtr /*(vtkImageAlgorithm*)*/ callingObject, int /*(int)*/ ARG_0);
...
bool GetInput_0(out IntPtr /*(vtkDataObject*)*/ return_value, IntPtr /*(vtkImageAlgorithm*)*/ callingObject, int /*(int)*/ port);

// vtkDataObject* GetInput()
// vtkDataObject *GetInput()
[DllImport("vtkplugin", EntryPoint="vtkImageAlgorithm_GetInput_1")] public static extern 
bool GetInput_1(out IntPtr /*(vtkDataObject*)*/ return_value, IntPtr /*(vtkImageAlgorithm*)*/ callingObject);

// vtkImageData* GetImageDataInput(int port)
// vtkImageData *GetImageDataInput(int port)
[DllImport("vtkplugin", EntryPoint="vtkImageAlgorithm_GetImageDataInput_0")] public static extern 
bool GetImageDataInput_0(out IntPtr /*(vtkImageData*)*/ return_value, IntPtr /*(vtkImageAlgorithm*)*/ callingObject, int /*(int)*/ port);
