...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkImplicitFunction*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkImplicitFunction*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkImplicitFunction* NewInstance()
// vtkImplicitFunction *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkImplicitFunction_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkImplicitFunction*)*/ return_value, IntPtr /*(vtkImplicitFunction*)*/ callingObject);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkImplicitFunction_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkImplicitFunction*)*/ callingObject);
...
bool FunctionValue_1(out double /*(double)*/ return_value, IntPtr /*(vtkImplicitFunction*)*/ callingObject, double /*(double[3])*/ []x);

// double FunctionValue(double x, double y, double z)
// double FunctionValue(double x, double y, double z)
[DllImport("vtkplugin", EntryPoint="vtkImplicitFunction_FunctionValue_2")] public static extern 
bool FunctionValue_2(out double /*(double)*/ return_value, IntPtr /*(vtkImplicitFunction*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool FunctionGradient_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkImplicitFunction*)*/ callingObject, double /*(double[3])*/ []x);

// double* FunctionGradient(double x, double y, double z)
// double *FunctionGradient(double x, double y, double z)
[DllImport("vtkplugin", EntryPoint="vtkImplicitFunction_FunctionGradient_2")] public static extern 
bool FunctionGradient_2(out double[] /*(double*)*/ return_value, IntPtr /*(vtkImplicitFunction*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool GetTransform_0(out IntPtr /*(vtkAbstractTransform*)*/ return_value, IntPtr /*(vtkImplicitFunction*)*/ callingObject);
...
bool EvaluateFunction_0(out double /*(double)*/ return_value, IntPtr /*(vtkImplicitFunction*)*/ callingObject, double /*(double[3])*/ []x);
...
bool EvaluateFunction_2(out double /*(double)*/ return_value, IntPtr /*(vtkImplicitFunction*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
