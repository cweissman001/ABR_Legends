...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkXMLParser*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkXMLParser* NewInstance()
// vtkXMLParser *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkXMLParser*)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);

// static vtkXMLParser* New()
// static vtkXMLParser* New()
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkXMLParser*)*/ return_value);

// vtkTypeInt64 TellG()
// vtkTypeInt64 TellG()
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_TellG_0")] public static extern 
bool TellG_0(out long /*(vtkTypeInt64)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);
...
bool Parse_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);

// virtual int Parse(const char * inputString)
// virtual int Parse(const char* inputString)
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_Parse_1")] public static extern 
bool Parse_1(out int /*(int)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject, string /*(char*)*/ inputString);
...
bool Parse_2(out int /*(int)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject, string /*(char*)*/ inputString, uint /*(unsigned int)*/ length);

// virtual int InitializeParser()
// virtual int InitializeParser()
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_InitializeParser_0")] public static extern 
bool InitializeParser_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);

// virtual int ParseChunk(const char * inputString, unsigned int length)
// virtual int ParseChunk(const char* inputString, unsigned int length)
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_ParseChunk_0")] public static extern 
bool ParseChunk_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject, string /*(char*)*/ inputString, uint /*(unsigned int)*/ length);

// virtual int CleanupParser()
// virtual int CleanupParser()
[DllImport("vtkplugin", EntryPoint="vtkXMLParser_CleanupParser_0")] public static extern 
bool CleanupParser_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);
...
bool GetFileName_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);
...
bool GetIgnoreCharacterData_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);
...
bool GetEncoding_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkXMLParser*)*/ callingObject);
