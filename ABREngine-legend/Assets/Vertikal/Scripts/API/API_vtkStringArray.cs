...
bool New_0(out IntPtr /*(vtkStringArray*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkStringArray*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkStringArray* NewInstance()
// vtkStringArray *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkStringArray_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkStringArray*)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject);

// int GetDataType()
// int GetDataType()
[DllImport("vtkplugin", EntryPoint="vtkStringArray_GetDataType_0")] public static extern 
bool GetDataType_0(out int /*(int)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject);

// int IsNumeric()
// int IsNumeric()
[DllImport("vtkplugin", EntryPoint="vtkStringArray_IsNumeric_0")] public static extern 
bool IsNumeric_0(out int /*(int)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject);
...
bool GetDataTypeSize_0(out int /*(int)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject);
...
bool Resize_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, long /*(vtkIdType)*/ numTuples);
...
bool InsertNextTuple_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, long /*(vtkIdType)*/ j, IntPtr /*(vtkAbstractArray*)*/ source);
...
bool InterpolateTuple_0(IntPtr /*(vtkStringArray*)*/ callingObject, long /*(vtkIdType)*/ i, IntPtr /*(vtkIdList*)*/ ptIndices, IntPtr /*(vtkAbstractArray*)*/ source, double[] /*(double*)*/ weights);
...
bool Allocate_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, long /*(vtkIdType)*/ sz, long /*(vtkIdType)*/ ext);

// vtkStdString& GetValue(vtkIdType id)
// vtkStdString &GetValue(vtkIdType id)
[DllImport("vtkplugin", EntryPoint="vtkStringArray_GetValue_0")] public static extern 
bool GetValue_0(out byte[] /*(vtkStdString*)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, long /*(vtkIdType)*/ id);
...
bool SetValue_1(IntPtr /*(vtkStringArray*)*/ callingObject, long /*(vtkIdType)*/ id, string /*(char*)*/ value);
...
bool GetNumberOfValues_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject);
...
bool GetNumberOfElementComponents_0(out int /*(int)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject);

// int GetElementComponentSize()
// int GetElementComponentSize()
[DllImport("vtkplugin", EntryPoint="vtkStringArray_GetElementComponentSize_0")] public static extern 
bool GetElementComponentSize_0(out int /*(int)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject);
...
bool InsertValue_1(IntPtr /*(vtkStringArray*)*/ callingObject, long /*(vtkIdType)*/ id, string /*(char*)*/ val);
...
bool InsertNextValue_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, string /*(vtkStdString)*/ f);
...
bool InsertNextValue_1(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, string /*(char*)*/ f);
...
bool WritePointer_0(out byte[] /*(vtkStdString*)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, long /*(vtkIdType)*/ id, long /*(vtkIdType)*/ number);

// vtkStdString* GetPointer(vtkIdType id)
// vtkStdString* GetPointer(vtkIdType id)
[DllImport("vtkplugin", EntryPoint="vtkStringArray_GetPointer_0")] public static extern 
bool GetPointer_0(out byte[] /*(vtkStdString*)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, long /*(vtkIdType)*/ id);

// void* GetVoidPointer(vtkIdType id)
// void* GetVoidPointer(vtkIdType id)
[DllImport("vtkplugin", EntryPoint="vtkStringArray_GetVoidPointer_0")] public static extern 
bool GetVoidPointer_0(out IntPtr /*(IntPtr*)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, long /*(vtkIdType)*/ id);
...
bool SetVoidArray_1(IntPtr /*(vtkStringArray*)*/ callingObject, IntPtr /*(void*)*/ array, long /*(vtkIdType)*/ size, int /*(int)*/ save, int /*(int)*/ deleteMethod);

// long GetActualMemorySize()
// unsigned long GetActualMemorySize()
[DllImport("vtkplugin", EntryPoint="vtkStringArray_GetActualMemorySize_0")] public static extern 
bool GetActualMemorySize_0(out ulong /*(unsigned long)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject);

// vtkArrayIterator* NewIterator()
// vtkArrayIterator* NewIterator()
[DllImport("vtkplugin", EntryPoint="vtkStringArray_NewIterator_0")] public static extern 
bool NewIterator_0(out IntPtr /*(vtkArrayIterator*)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject);

// vtkIdType GetDataSize()
// vtkIdType GetDataSize()
[DllImport("vtkplugin", EntryPoint="vtkStringArray_GetDataSize_0")] public static extern 
bool GetDataSize_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject);
...
bool LookupValue_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, string /*(vtkStdString&)*/ value);
...
bool LookupValue_1(IntPtr /*(vtkStringArray*)*/ callingObject, string /*(vtkStdString&)*/ value, IntPtr /*(vtkIdList*)*/ ids);

// vtkIdType LookupValue(const char * value)
// vtkIdType LookupValue(const char* value)
[DllImport("vtkplugin", EntryPoint="vtkStringArray_LookupValue_2")] public static extern 
bool LookupValue_2(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkStringArray*)*/ callingObject, string /*(char*)*/ value);
...
bool LookupValue_3(IntPtr /*(vtkStringArray*)*/ callingObject, string /*(char*)*/ value, IntPtr /*(vtkIdList*)*/ ids);
