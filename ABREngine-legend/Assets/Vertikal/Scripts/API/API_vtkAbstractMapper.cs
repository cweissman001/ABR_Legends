...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractMapper*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAbstractMapper*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAbstractMapper* NewInstance()
// vtkAbstractMapper *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAbstractMapper_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAbstractMapper*)*/ return_value, IntPtr /*(vtkAbstractMapper*)*/ callingObject);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkAbstractMapper_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkAbstractMapper*)*/ callingObject);
...
bool GetTimeToDraw_0(out double /*(double)*/ return_value, IntPtr /*(vtkAbstractMapper*)*/ callingObject);
...
bool GetClippingPlanes_0(out IntPtr /*(vtkPlaneCollection*)*/ return_value, IntPtr /*(vtkAbstractMapper*)*/ callingObject);
...
bool GetScalars_0(out IntPtr /*(vtkDataArray*)*/ return_value, IntPtr /*(vtkDataSet*)*/ input, int /*(int)*/ scalarMode, int /*(int)*/ arrayAccessMode, int /*(int)*/ arrayId, string /*(char*)*/ arrayName, IntPtr /*(int&)*/ cellFlag);
...
bool GetAbstractScalars_0(out IntPtr /*(vtkAbstractArray*)*/ return_value, IntPtr /*(vtkDataSet*)*/ input, int /*(int)*/ scalarMode, int /*(int)*/ arrayAccessMode, int /*(int)*/ arrayId, string /*(char*)*/ arrayName, IntPtr /*(int&)*/ cellFlag);

// int GetNumberOfClippingPlanes()
// int GetNumberOfClippingPlanes()
[DllImport("vtkplugin", EntryPoint="vtkAbstractMapper_GetNumberOfClippingPlanes_0")] public static extern 
bool GetNumberOfClippingPlanes_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractMapper*)*/ callingObject);
