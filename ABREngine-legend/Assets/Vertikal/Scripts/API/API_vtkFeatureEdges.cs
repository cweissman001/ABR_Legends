...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkFeatureEdges*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkFeatureEdges* NewInstance()
// vtkFeatureEdges *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkFeatureEdges_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkFeatureEdges*)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);

// static vtkFeatureEdges* New()
// static vtkFeatureEdges *New()
[DllImport("vtkplugin", EntryPoint="vtkFeatureEdges_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkFeatureEdges*)*/ return_value);
...
bool SetBoundaryEdges_0(IntPtr /*(vtkFeatureEdges*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetBoundaryEdges_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);
...
bool SetFeatureEdges_0(IntPtr /*(vtkFeatureEdges*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);

// virtual vtkTypeBool GetFeatureEdges()
// virtual vtkTypeBool GetFeatureEdges ()
[DllImport("vtkplugin", EntryPoint="vtkFeatureEdges_GetFeatureEdges_0")] public static extern 
bool GetFeatureEdges_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);
...
bool GetFeatureAngleMinValue_0(out double /*(double)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);
...
bool GetFeatureAngleMaxValue_0(out double /*(double)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);

// virtual double GetFeatureAngle()
// virtual double GetFeatureAngle ()
[DllImport("vtkplugin", EntryPoint="vtkFeatureEdges_GetFeatureAngle_0")] public static extern 
bool GetFeatureAngle_0(out double /*(double)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);
...
bool SetNonManifoldEdges_0(IntPtr /*(vtkFeatureEdges*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetNonManifoldEdges_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);
...
bool SetManifoldEdges_0(IntPtr /*(vtkFeatureEdges*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetManifoldEdges_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);
...
bool SetColoring_0(IntPtr /*(vtkFeatureEdges*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);

// virtual vtkTypeBool GetColoring()
// virtual vtkTypeBool GetColoring ()
[DllImport("vtkplugin", EntryPoint="vtkFeatureEdges_GetColoring_0")] public static extern 
bool GetColoring_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);
...
bool GetLocator_0(out IntPtr /*(vtkIncrementalPointLocator*)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);
...
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);
...
bool GetOutputPointsPrecision_0(out int /*(int)*/ return_value, IntPtr /*(vtkFeatureEdges*)*/ callingObject);
