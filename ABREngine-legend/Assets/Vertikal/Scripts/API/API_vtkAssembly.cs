...
bool New_0(out IntPtr /*(vtkAssembly*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAssembly*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAssembly* NewInstance()
// vtkAssembly *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAssembly_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAssembly*)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject);
...
bool GetParts_0(out IntPtr /*(vtkProp3DCollection*)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject);
...
bool RenderOpaqueGeometry_0(out int /*(int)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ren);
...
bool RenderTranslucentPolygonalGeometry_0(out int /*(int)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ren);
...
bool RenderVolumetricGeometry_0(out int /*(int)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ren);
...
bool HasTranslucentPolygonalGeometry_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject);
...
bool GetNextPath_0(out IntPtr /*(vtkAssemblyPath*)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject);

// int GetNumberOfPaths()
// int GetNumberOfPaths()
[DllImport("vtkplugin", EntryPoint="vtkAssembly_GetNumberOfPaths_0")] public static extern 
bool GetNumberOfPaths_0(out int /*(int)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject);
...
bool GetBounds_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkAssembly_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkAssembly*)*/ callingObject);
