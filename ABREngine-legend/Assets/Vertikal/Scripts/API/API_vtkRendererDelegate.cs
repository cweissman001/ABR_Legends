...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkRendererDelegate*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkRendererDelegate*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkRendererDelegate* NewInstance()
// vtkRendererDelegate *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkRendererDelegate_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkRendererDelegate*)*/ return_value, IntPtr /*(vtkRendererDelegate*)*/ callingObject);
...
bool GetUsed_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkRendererDelegate*)*/ callingObject);
