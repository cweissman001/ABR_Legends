...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkProperty2D*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkProperty2D* NewInstance()
// vtkProperty2D *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkProperty2D_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkProperty2D*)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);

// static vtkProperty2D* New()
// static vtkProperty2D *New()
[DllImport("vtkplugin", EntryPoint="vtkProperty2D_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkProperty2D*)*/ return_value);
...
bool GetColor_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetOpacity_0(out double /*(double)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetPointSizeMinValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetPointSizeMaxValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);

// virtual float GetPointSize()
// virtual float GetPointSize ()
[DllImport("vtkplugin", EntryPoint="vtkProperty2D_GetPointSize_0")] public static extern 
bool GetPointSize_0(out float /*(float)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetLineWidthMinValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetLineWidthMaxValue_0(out float /*(float)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);

// virtual float GetLineWidth()
// virtual float GetLineWidth ()
[DllImport("vtkplugin", EntryPoint="vtkProperty2D_GetLineWidth_0")] public static extern 
bool GetLineWidth_0(out float /*(float)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetLineStipplePattern_0(out int /*(int)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetLineStippleRepeatFactorMinValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetLineStippleRepeatFactorMaxValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetLineStippleRepeatFactor_0(out int /*(int)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetDisplayLocationMinValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
...
bool GetDisplayLocationMaxValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);

// virtual int GetDisplayLocation()
// virtual int GetDisplayLocation ()
[DllImport("vtkplugin", EntryPoint="vtkProperty2D_GetDisplayLocation_0")] public static extern 
bool GetDisplayLocation_0(out int /*(int)*/ return_value, IntPtr /*(vtkProperty2D*)*/ callingObject);
