...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkXMLReader*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkXMLReader* NewInstance()
// vtkXMLReader *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkXMLReader*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);
...
bool GetFileName_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);
...
bool SetReadFromInputString_0(IntPtr /*(vtkXMLReader*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetReadFromInputString_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);
...
bool CanReadFile_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject, string /*(char*)*/ name);

// vtkDataSet* GetOutputAsDataSet()
// vtkDataSet* GetOutputAsDataSet()
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetOutputAsDataSet_0")] public static extern 
bool GetOutputAsDataSet_0(out IntPtr /*(vtkDataSet*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);

// vtkDataSet* GetOutputAsDataSet(int index)
// vtkDataSet* GetOutputAsDataSet(int index)
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetOutputAsDataSet_1")] public static extern 
bool GetOutputAsDataSet_1(out IntPtr /*(vtkDataSet*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject, int /*(int)*/ index);

// virtual vtkDataArraySelection* GetPointDataArraySelection()
// virtual vtkDataArraySelection *GetPointDataArraySelection ()
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetPointDataArraySelection_0")] public static extern 
bool GetPointDataArraySelection_0(out IntPtr /*(vtkDataArraySelection*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);

// virtual vtkDataArraySelection* GetCellDataArraySelection()
// virtual vtkDataArraySelection *GetCellDataArraySelection ()
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetCellDataArraySelection_0")] public static extern 
bool GetCellDataArraySelection_0(out IntPtr /*(vtkDataArraySelection*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);
...
bool GetColumnArraySelection_0(out IntPtr /*(vtkDataArraySelection*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);

// int GetNumberOfPointArrays()
// int GetNumberOfPointArrays()
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetNumberOfPointArrays_0")] public static extern 
bool GetNumberOfPointArrays_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);

// int GetNumberOfCellArrays()
// int GetNumberOfCellArrays()
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetNumberOfCellArrays_0")] public static extern 
bool GetNumberOfCellArrays_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);

// int GetNumberOfColumnArrays()
// int GetNumberOfColumnArrays()
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetNumberOfColumnArrays_0")] public static extern 
bool GetNumberOfColumnArrays_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);
...
bool GetPointArrayName_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject, int /*(int)*/ index);
...
bool GetCellArrayName_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject, int /*(int)*/ index);
...
bool GetColumnArrayName_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject, int /*(int)*/ index);

// int GetPointArrayStatus(const char * name)
// int GetPointArrayStatus(const char* name)
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetPointArrayStatus_0")] public static extern 
bool GetPointArrayStatus_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject, string /*(char*)*/ name);

// int GetCellArrayStatus(const char * name)
// int GetCellArrayStatus(const char* name)
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetCellArrayStatus_0")] public static extern 
bool GetCellArrayStatus_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject, string /*(char*)*/ name);
...
bool GetColumnArrayStatus_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject, string /*(char*)*/ name);
...
bool GetTimeStep_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);

// virtual int GetNumberOfTimeSteps()
// virtual int GetNumberOfTimeSteps ()
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetNumberOfTimeSteps_0")] public static extern 
bool GetNumberOfTimeSteps_0(out int /*(int)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);

// virtual int* GetTimeStepRange()
// virtual int *GetTimeStepRange ()
[DllImport("vtkplugin", EntryPoint="vtkXMLReader_GetTimeStepRange_0")] public static extern 
bool GetTimeStepRange_0(out int[] /*(int*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);
...
bool GetXMLParser_0(out IntPtr /*(vtkXMLDataParser*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);
...
bool GetReaderErrorObserver_0(out IntPtr /*(vtkCommand*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);
...
bool GetParserErrorObserver_0(out IntPtr /*(vtkCommand*)*/ return_value, IntPtr /*(vtkXMLReader*)*/ callingObject);
