...
bool New_0(out IntPtr /*(vtkStructuredGrid*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkStructuredGrid*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkStructuredGrid* NewInstance()
// vtkStructuredGrid *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkStructuredGrid_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkStructuredGrid*)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);

// int GetDataObjectType()
// int GetDataObjectType()
[DllImport("vtkplugin", EntryPoint="vtkStructuredGrid_GetDataObjectType_0")] public static extern 
bool GetDataObjectType_0(out int /*(int)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);
...
bool GetNumberOfPoints_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);

// double* GetPoint(vtkIdType ptId)
// double *GetPoint(vtkIdType ptId)
[DllImport("vtkplugin", EntryPoint="vtkStructuredGrid_GetPoint_0")] public static extern 
bool GetPoint_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject, long /*(vtkIdType)*/ ptId);
...
bool GetCell_0(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject, long /*(vtkIdType)*/ cellId);

// vtkCell* GetCell(int i, int j, int k)
// vtkCell *GetCell(int i, int j, int k)
[DllImport("vtkplugin", EntryPoint="vtkStructuredGrid_GetCell_1")] public static extern 
bool GetCell_1(out IntPtr /*(vtkCell*)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject, int /*(int)*/ i, int /*(int)*/ j, int /*(int)*/ k);
...
bool GetCellType_0(out int /*(int)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject, long /*(vtkIdType)*/ cellId);

// vtkIdType GetNumberOfCells()
// vtkIdType GetNumberOfCells()
[DllImport("vtkplugin", EntryPoint="vtkStructuredGrid_GetNumberOfCells_0")] public static extern 
bool GetNumberOfCells_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);
...
bool GetMaxCellSize_0(out int /*(int)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);
...
bool GetCellNeighbors_1(IntPtr /*(vtkStructuredGrid*)*/ callingObject, long /*(vtkIdType)*/ cellId, IntPtr /*(vtkIdList*)*/ ptIds, IntPtr /*(vtkIdList*)*/ cellIds, int[] /*(int*)*/ seedLoc);
...
bool GetDimensions_0(out int[] /*(int*)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);
...
bool GetDataDimension_0(out int /*(int)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);
...
bool GetExtent_0(out int[] /*(int*)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);
...
bool GetActualMemorySize_0(out ulong /*(unsigned long)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);
...
bool GetExtentType_0(out int /*(int)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);
...
bool IsPointVisible_0(out char /*(unsigned char)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject, long /*(vtkIdType)*/ ptId);
...
bool IsCellVisible_0(out char /*(unsigned char)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject, long /*(vtkIdType)*/ cellId);

// bool HasAnyBlankPoints()
// bool HasAnyBlankPoints()
[DllImport("vtkplugin", EntryPoint="vtkStructuredGrid_HasAnyBlankPoints_0")] public static extern 
bool HasAnyBlankPoints_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);

// bool HasAnyBlankCells()
// bool HasAnyBlankCells()
[DllImport("vtkplugin", EntryPoint="vtkStructuredGrid_HasAnyBlankCells_0")] public static extern 
bool HasAnyBlankCells_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkStructuredGrid*)*/ callingObject);
...
bool Crop_0(IntPtr /*(vtkStructuredGrid*)*/ callingObject, int[] /*(int*)*/ updateExtent);
