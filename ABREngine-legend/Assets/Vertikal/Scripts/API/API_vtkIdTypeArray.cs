...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkIdTypeArray*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkIdTypeArray*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkIdTypeArray* NewInstance()
// vtkIdTypeArray *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkIdTypeArray_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkIdTypeArray*)*/ return_value, IntPtr /*(vtkIdTypeArray*)*/ callingObject);

// static vtkIdTypeArray* New()
// static vtkIdTypeArray* New()
[DllImport("vtkplugin", EntryPoint="vtkIdTypeArray_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkIdTypeArray*)*/ return_value);

// int GetDataType()
// int GetDataType()
[DllImport("vtkplugin", EntryPoint="vtkIdTypeArray_GetDataType_0")] public static extern 
bool GetDataType_0(out int /*(int)*/ return_value, IntPtr /*(vtkIdTypeArray*)*/ callingObject);
...
bool FastDownCast_0(out IntPtr /*(vtkIdTypeArray*)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ source);
...
bool GetDataTypeValueMin_0(out long /*(vtkIdType)*/ return_value);
...
bool GetDataTypeValueMax_0(out long /*(vtkIdType)*/ return_value);
