...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkCuller*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkCuller*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkCuller* NewInstance()
// vtkCuller *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkCuller_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkCuller*)*/ return_value, IntPtr /*(vtkCuller*)*/ callingObject);
...
bool Cull_0(out double /*(double)*/ return_value, IntPtr /*(vtkCuller*)*/ callingObject, IntPtr /*(vtkRenderer*)*/ ren, IntPtr /*(vtkProp**)*/ propList, IntPtr /*(int&)*/ listLength, IntPtr /*(int&)*/ initialized);
