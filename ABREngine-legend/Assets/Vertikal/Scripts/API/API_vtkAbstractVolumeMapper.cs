...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAbstractVolumeMapper*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);
...
bool NewInstance_0(out IntPtr /*(vtkAbstractVolumeMapper*)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);
...
bool GetDataSetInput_0(out IntPtr /*(vtkDataSet*)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);
...
bool GetDataObjectInput_0(out IntPtr /*(vtkDataObject*)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);

// double* GetBounds()
// double *GetBounds()
[DllImport("vtkplugin", EntryPoint="vtkAbstractVolumeMapper_GetBounds_0")] public static extern 
bool GetBounds_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);
...
bool GetScalarMode_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);
...
bool GetArrayName_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);

// virtual int GetArrayId()
// virtual int GetArrayId()
[DllImport("vtkplugin", EntryPoint="vtkAbstractVolumeMapper_GetArrayId_0")] public static extern 
bool GetArrayId_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);

// virtual int GetArrayAccessMode()
// virtual int GetArrayAccessMode()
[DllImport("vtkplugin", EntryPoint="vtkAbstractVolumeMapper_GetArrayAccessMode_0")] public static extern 
bool GetArrayAccessMode_0(out int /*(int)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);
...
bool GetScalarModeAsString_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);

// virtual float GetGradientMagnitudeScale()
// virtual float GetGradientMagnitudeScale()
[DllImport("vtkplugin", EntryPoint="vtkAbstractVolumeMapper_GetGradientMagnitudeScale_0")] public static extern 
bool GetGradientMagnitudeScale_0(out float /*(float)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);

// virtual float GetGradientMagnitudeBias()
// virtual float GetGradientMagnitudeBias()
[DllImport("vtkplugin", EntryPoint="vtkAbstractVolumeMapper_GetGradientMagnitudeBias_0")] public static extern 
bool GetGradientMagnitudeBias_0(out float /*(float)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject);
...
bool GetGradientMagnitudeScale_1(out float /*(float)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject, int /*(int)*/ ARG_0);
...
bool GetGradientMagnitudeBias_1(out float /*(float)*/ return_value, IntPtr /*(vtkAbstractVolumeMapper*)*/ callingObject, int /*(int)*/ ARG_0);
