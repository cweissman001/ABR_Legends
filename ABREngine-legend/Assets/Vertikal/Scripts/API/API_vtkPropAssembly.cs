...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPropAssembly*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkPropAssembly* NewInstance()
// vtkPropAssembly *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkPropAssembly_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkPropAssembly*)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject);

// static vtkPropAssembly* New()
// static vtkPropAssembly *New()
[DllImport("vtkplugin", EntryPoint="vtkPropAssembly_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkPropAssembly*)*/ return_value);
...
bool GetParts_0(out IntPtr /*(vtkPropCollection*)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject);
...
bool RenderOpaqueGeometry_0(out int /*(int)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ren);
...
bool RenderTranslucentPolygonalGeometry_0(out int /*(int)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ren);
...
bool RenderVolumetricGeometry_0(out int /*(int)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ren);

// int RenderOverlay(vtkViewport * ren)
// int RenderOverlay(vtkViewport *ren)
[DllImport("vtkplugin", EntryPoint="vtkPropAssembly_RenderOverlay_0")] public static extern 
bool RenderOverlay_0(out int /*(int)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject, IntPtr /*(vtkViewport*)*/ ren);
...
bool HasTranslucentPolygonalGeometry_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject);
...
bool GetBounds_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject);
...
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject);
...
bool GetNextPath_0(out IntPtr /*(vtkAssemblyPath*)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject);

// int GetNumberOfPaths()
// int GetNumberOfPaths()
[DllImport("vtkplugin", EntryPoint="vtkPropAssembly_GetNumberOfPaths_0")] public static extern 
bool GetNumberOfPaths_0(out int /*(int)*/ return_value, IntPtr /*(vtkPropAssembly*)*/ callingObject);
