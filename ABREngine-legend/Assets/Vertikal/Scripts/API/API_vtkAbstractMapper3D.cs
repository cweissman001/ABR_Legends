...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractMapper3D*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAbstractMapper3D*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAbstractMapper3D* NewInstance()
// vtkAbstractMapper3D *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAbstractMapper3D_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAbstractMapper3D*)*/ return_value, IntPtr /*(vtkAbstractMapper3D*)*/ callingObject);

// virtual double* GetBounds()
// virtual double *GetBounds()
[DllImport("vtkplugin", EntryPoint="vtkAbstractMapper3D_GetBounds_0")] public static extern 
bool GetBounds_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractMapper3D*)*/ callingObject);
...
bool GetCenter_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkAbstractMapper3D*)*/ callingObject);
...
bool GetLength_0(out double /*(double)*/ return_value, IntPtr /*(vtkAbstractMapper3D*)*/ callingObject);
...
bool IsARayCastMapper_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractMapper3D*)*/ callingObject);
...
bool IsARenderIntoImageMapper_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractMapper3D*)*/ callingObject);
