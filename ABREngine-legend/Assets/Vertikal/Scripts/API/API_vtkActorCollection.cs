...
bool New_0(out IntPtr /*(vtkActorCollection*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkActorCollection*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkActorCollection*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkActorCollection* NewInstance()
// vtkActorCollection *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkActorCollection_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkActorCollection*)*/ return_value, IntPtr /*(vtkActorCollection*)*/ callingObject);
...
bool GetNextActor_0(out IntPtr /*(vtkActor*)*/ return_value, IntPtr /*(vtkActorCollection*)*/ callingObject);

// vtkActor* GetLastActor()
// vtkActor *GetLastActor()
[DllImport("vtkplugin", EntryPoint="vtkActorCollection_GetLastActor_0")] public static extern 
bool GetLastActor_0(out IntPtr /*(vtkActor*)*/ return_value, IntPtr /*(vtkActorCollection*)*/ callingObject);

// vtkActor* GetNextItem()
// vtkActor *GetNextItem()
[DllImport("vtkplugin", EntryPoint="vtkActorCollection_GetNextItem_0")] public static extern 
bool GetNextItem_0(out IntPtr /*(vtkActor*)*/ return_value, IntPtr /*(vtkActorCollection*)*/ callingObject);

// vtkActor* GetLastItem()
// vtkActor *GetLastItem()
[DllImport("vtkplugin", EntryPoint="vtkActorCollection_GetLastItem_0")] public static extern 
bool GetLastItem_0(out IntPtr /*(vtkActor*)*/ return_value, IntPtr /*(vtkActorCollection*)*/ callingObject);
