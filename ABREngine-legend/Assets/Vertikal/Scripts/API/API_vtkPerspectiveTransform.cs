...
bool New_0(out IntPtr /*(vtkPerspectiveTransform*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPerspectiveTransform*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPerspectiveTransform*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);
...
bool NewInstance_0(out IntPtr /*(vtkPerspectiveTransform*)*/ return_value, IntPtr /*(vtkPerspectiveTransform*)*/ callingObject);
...
bool GetNumberOfConcatenatedTransforms_0(out int /*(int)*/ return_value, IntPtr /*(vtkPerspectiveTransform*)*/ callingObject);
...
bool GetConcatenatedTransform_0(out IntPtr /*(vtkHomogeneousTransform*)*/ return_value, IntPtr /*(vtkPerspectiveTransform*)*/ callingObject, int /*(int)*/ i);
...
bool GetInput_0(out IntPtr /*(vtkHomogeneousTransform*)*/ return_value, IntPtr /*(vtkPerspectiveTransform*)*/ callingObject);

// int GetInverseFlag()
// int GetInverseFlag()
[DllImport("vtkplugin", EntryPoint="vtkPerspectiveTransform_GetInverseFlag_0")] public static extern 
bool GetInverseFlag_0(out int /*(int)*/ return_value, IntPtr /*(vtkPerspectiveTransform*)*/ callingObject);
...
bool MakeTransform_0(out IntPtr /*(vtkAbstractTransform*)*/ return_value, IntPtr /*(vtkPerspectiveTransform*)*/ callingObject);
...
bool CircuitCheck_0(out int /*(int)*/ return_value, IntPtr /*(vtkPerspectiveTransform*)*/ callingObject, IntPtr /*(vtkAbstractTransform*)*/ transform);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkPerspectiveTransform_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkPerspectiveTransform*)*/ callingObject);
