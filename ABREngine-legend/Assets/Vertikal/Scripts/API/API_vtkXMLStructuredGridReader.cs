...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkXMLStructuredGridReader*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkXMLStructuredGridReader*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);
...
bool NewInstance_0(out IntPtr /*(vtkXMLStructuredGridReader*)*/ return_value, IntPtr /*(vtkXMLStructuredGridReader*)*/ callingObject);
...
bool New_0(out IntPtr /*(vtkXMLStructuredGridReader*)*/ return_value);

// vtkStructuredGrid* GetOutput()
// vtkStructuredGrid *GetOutput()
[DllImport("vtkplugin", EntryPoint="vtkXMLStructuredGridReader_GetOutput_0")] public static extern 
bool GetOutput_0(out IntPtr /*(vtkStructuredGrid*)*/ return_value, IntPtr /*(vtkXMLStructuredGridReader*)*/ callingObject);

// vtkStructuredGrid* GetOutput(int idx)
// vtkStructuredGrid *GetOutput(int idx)
[DllImport("vtkplugin", EntryPoint="vtkXMLStructuredGridReader_GetOutput_1")] public static extern 
bool GetOutput_1(out IntPtr /*(vtkStructuredGrid*)*/ return_value, IntPtr /*(vtkXMLStructuredGridReader*)*/ callingObject, int /*(int)*/ idx);
