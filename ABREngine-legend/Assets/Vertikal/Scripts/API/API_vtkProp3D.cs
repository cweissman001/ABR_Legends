...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkProp3D*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkProp3D* NewInstance()
// vtkProp3D *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkProp3D_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkProp3D*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetPosition_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetOrigin_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetScale_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetUserTransform_0(out IntPtr /*(vtkLinearTransform*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetUserMatrix_0(out IntPtr /*(vtkMatrix4x4*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetBounds_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);

// double* GetCenter()
// double *GetCenter()
[DllImport("vtkplugin", EntryPoint="vtkProp3D_GetCenter_0")] public static extern 
bool GetCenter_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);

// double* GetXRange()
// double *GetXRange()
[DllImport("vtkplugin", EntryPoint="vtkProp3D_GetXRange_0")] public static extern 
bool GetXRange_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);

// double* GetYRange()
// double *GetYRange()
[DllImport("vtkplugin", EntryPoint="vtkProp3D_GetYRange_0")] public static extern 
bool GetYRange_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);

// double* GetZRange()
// double *GetZRange()
[DllImport("vtkplugin", EntryPoint="vtkProp3D_GetZRange_0")] public static extern 
bool GetZRange_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);

// double GetLength()
// double GetLength()
[DllImport("vtkplugin", EntryPoint="vtkProp3D_GetLength_0")] public static extern 
bool GetLength_0(out double /*(double)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetOrientation_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetOrientationWXYZ_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetUserTransformMatrixMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
...
bool GetMatrix_2(out IntPtr /*(vtkMatrix4x4*)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);

// virtual int GetIsIdentity()
// virtual int GetIsIdentity ()
[DllImport("vtkplugin", EntryPoint="vtkProp3D_GetIsIdentity_0")] public static extern 
bool GetIsIdentity_0(out int /*(int)*/ return_value, IntPtr /*(vtkProp3D*)*/ callingObject);
