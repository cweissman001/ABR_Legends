...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkAbstractCellLinks*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkAbstractCellLinks*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkAbstractCellLinks* NewInstance()
// vtkAbstractCellLinks *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkAbstractCellLinks_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkAbstractCellLinks*)*/ return_value, IntPtr /*(vtkAbstractCellLinks*)*/ callingObject);
...
bool GetIdType_0(out int /*(int)*/ return_value, long /*(vtkIdType)*/ maxPtId, long /*(vtkIdType)*/ maxCellId, IntPtr /*(vtkCellArray*)*/ ca);
