...
bool New_0(out IntPtr /*(vtkThreshold*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkThreshold*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkThreshold* NewInstance()
// vtkThreshold *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkThreshold_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkThreshold*)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool GetUpperThreshold_0(out double /*(double)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);

// virtual double GetLowerThreshold()
// virtual double GetLowerThreshold ()
[DllImport("vtkplugin", EntryPoint="vtkThreshold_GetLowerThreshold_0")] public static extern 
bool GetLowerThreshold_0(out double /*(double)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool GetAttributeMode_0(out int /*(int)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool GetAttributeModeAsString_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool GetComponentModeMinValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool GetComponentModeMaxValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);

// virtual int GetComponentMode()
// virtual int GetComponentMode ()
[DllImport("vtkplugin", EntryPoint="vtkThreshold_GetComponentMode_0")] public static extern 
bool GetComponentMode_0(out int /*(int)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool GetComponentModeAsString_0(out byte[] /*(char*)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool GetSelectedComponentMinValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool GetSelectedComponentMaxValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);

// virtual int GetSelectedComponent()
// virtual int GetSelectedComponent ()
[DllImport("vtkplugin", EntryPoint="vtkThreshold_GetSelectedComponent_0")] public static extern 
bool GetSelectedComponent_0(out int /*(int)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool SetAllScalars_0(IntPtr /*(vtkThreshold*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);

// virtual vtkTypeBool GetAllScalars()
// virtual vtkTypeBool GetAllScalars ()
[DllImport("vtkplugin", EntryPoint="vtkThreshold_GetAllScalars_0")] public static extern 
bool GetAllScalars_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool SetUseContinuousCellRange_0(IntPtr /*(vtkThreshold*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetUseContinuousCellRange_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool GetPointsDataType_0(out int /*(int)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);

// virtual void SetInvert(bool _arg)
// virtual void SetInvert (bool _arg)
[DllImport("vtkplugin", EntryPoint="vtkThreshold_SetInvert_0")] public static extern 
bool SetInvert_0(IntPtr /*(vtkThreshold*)*/ callingObject, bool /*(bool)*/ _arg);

// virtual bool GetInvert()
// virtual bool GetInvert ()
[DllImport("vtkplugin", EntryPoint="vtkThreshold_GetInvert_0")] public static extern 
bool GetInvert_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);

// virtual void InvertOn()
// virtual void InvertOn ()
[DllImport("vtkplugin", EntryPoint="vtkThreshold_InvertOn_0")] public static extern 
bool InvertOn_0(IntPtr /*(vtkThreshold*)*/ callingObject);

// virtual void InvertOff()
// virtual void InvertOff ()
[DllImport("vtkplugin", EntryPoint="vtkThreshold_InvertOff_0")] public static extern 
bool InvertOff_0(IntPtr /*(vtkThreshold*)*/ callingObject);
...
bool GetOutputPointsPrecision_0(out int /*(int)*/ return_value, IntPtr /*(vtkThreshold*)*/ callingObject);
