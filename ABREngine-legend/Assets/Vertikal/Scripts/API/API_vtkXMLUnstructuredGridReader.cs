...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkXMLUnstructuredGridReader*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkXMLUnstructuredGridReader*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);
...
bool NewInstance_0(out IntPtr /*(vtkXMLUnstructuredGridReader*)*/ return_value, IntPtr /*(vtkXMLUnstructuredGridReader*)*/ callingObject);
...
bool New_0(out IntPtr /*(vtkXMLUnstructuredGridReader*)*/ return_value);

// vtkUnstructuredGrid* GetOutput()
// vtkUnstructuredGrid *GetOutput()
[DllImport("vtkplugin", EntryPoint="vtkXMLUnstructuredGridReader_GetOutput_0")] public static extern 
bool GetOutput_0(out IntPtr /*(vtkUnstructuredGrid*)*/ return_value, IntPtr /*(vtkXMLUnstructuredGridReader*)*/ callingObject);

// vtkUnstructuredGrid* GetOutput(int idx)
// vtkUnstructuredGrid *GetOutput(int idx)
[DllImport("vtkplugin", EntryPoint="vtkXMLUnstructuredGridReader_GetOutput_1")] public static extern 
bool GetOutput_1(out IntPtr /*(vtkUnstructuredGrid*)*/ return_value, IntPtr /*(vtkXMLUnstructuredGridReader*)*/ callingObject, int /*(int)*/ idx);
