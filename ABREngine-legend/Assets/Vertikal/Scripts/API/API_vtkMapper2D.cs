...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkMapper2D*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkMapper2D*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkMapper2D* NewInstance()
// vtkMapper2D *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkMapper2D_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkMapper2D*)*/ return_value, IntPtr /*(vtkMapper2D*)*/ callingObject);
...
bool HasTranslucentPolygonalGeometry_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkMapper2D*)*/ callingObject);
