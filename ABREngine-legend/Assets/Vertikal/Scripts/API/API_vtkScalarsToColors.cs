...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkScalarsToColors*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkScalarsToColors* NewInstance()
// vtkScalarsToColors *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkScalarsToColors_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkScalarsToColors*)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);

// static vtkScalarsToColors* New()
// static vtkScalarsToColors *New()
[DllImport("vtkplugin", EntryPoint="vtkScalarsToColors_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkScalarsToColors*)*/ return_value);

// virtual int IsOpaque()
// virtual int IsOpaque()
[DllImport("vtkplugin", EntryPoint="vtkScalarsToColors_IsOpaque_0")] public static extern 
bool IsOpaque_0(out int /*(int)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);
...
bool GetRange_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);
...
bool GetColor_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject, double /*(double)*/ v);

// virtual double GetOpacity(double v)
// virtual double GetOpacity(double v)
[DllImport("vtkplugin", EntryPoint="vtkScalarsToColors_GetOpacity_0")] public static extern 
bool GetOpacity_0(out double /*(double)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject, double /*(double)*/ v);

// double GetLuminance(double x)
// double GetLuminance(double x)
[DllImport("vtkplugin", EntryPoint="vtkScalarsToColors_GetLuminance_0")] public static extern 
bool GetLuminance_0(out double /*(double)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject, double /*(double)*/ x);
...
bool GetAlpha_0(out double /*(double)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);
...
bool MapScalars_0(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject, IntPtr /*(vtkDataArray*)*/ scalars, int /*(int)*/ colorMode, int /*(int)*/ component);
...
bool MapScalars_1(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject, IntPtr /*(vtkAbstractArray*)*/ scalars, int /*(int)*/ colorMode, int /*(int)*/ component);
...
bool GetVectorMode_0(out int /*(int)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);
...
bool GetVectorComponent_0(out int /*(int)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);
...
bool GetVectorSize_0(out int /*(int)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);
...
bool UsingLogScale_0(out int /*(int)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);

// virtual vtkIdType GetNumberOfAvailableColors()
// virtual vtkIdType GetNumberOfAvailableColors()
[DllImport("vtkplugin", EntryPoint="vtkScalarsToColors_GetNumberOfAvailableColors_0")] public static extern 
bool GetNumberOfAvailableColors_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);
...
bool GetAnnotatedValues_0(out IntPtr /*(vtkAbstractArray*)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);
...
bool GetAnnotations_0(out IntPtr /*(vtkStringArray*)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);

// virtual vtkIdType SetAnnotation(vtkStdString value, vtkStdString annotation)
// virtual vtkIdType SetAnnotation(vtkStdString value, vtkStdString annotation)
[DllImport("vtkplugin", EntryPoint="vtkScalarsToColors_SetAnnotation_0")] public static extern 
bool SetAnnotation_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject, string /*(vtkStdString)*/ value, string /*(vtkStdString)*/ annotation);

// vtkIdType GetNumberOfAnnotatedValues()
// vtkIdType GetNumberOfAnnotatedValues()
[DllImport("vtkplugin", EntryPoint="vtkScalarsToColors_GetNumberOfAnnotatedValues_0")] public static extern 
bool GetNumberOfAnnotatedValues_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);

// vtkStdString GetAnnotation(vtkIdType idx)
// vtkStdString GetAnnotation(vtkIdType idx)
[DllImport("vtkplugin", EntryPoint="vtkScalarsToColors_GetAnnotation_0")] public static extern 
bool GetAnnotation_0(out byte[] /*(vtkStdString)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject, long /*(vtkIdType)*/ idx);
...
bool SetIndexedLookup_0(IntPtr /*(vtkScalarsToColors*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetIndexedLookup_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkScalarsToColors*)*/ callingObject);
