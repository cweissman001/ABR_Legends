...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkLocator*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkLocator*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkLocator* NewInstance()
// vtkLocator *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkLocator_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkLocator*)*/ return_value, IntPtr /*(vtkLocator*)*/ callingObject);
...
bool GetDataSet_0(out IntPtr /*(vtkDataSet*)*/ return_value, IntPtr /*(vtkLocator*)*/ callingObject);
...
bool GetToleranceMinValue_0(out double /*(double)*/ return_value, IntPtr /*(vtkLocator*)*/ callingObject);

// virtual double GetToleranceMaxValue()
// virtual double GetToleranceMaxValue ()
[DllImport("vtkplugin", EntryPoint="vtkLocator_GetToleranceMaxValue_0")] public static extern 
bool GetToleranceMaxValue_0(out double /*(double)*/ return_value, IntPtr /*(vtkLocator*)*/ callingObject);

// virtual double GetTolerance()
// virtual double GetTolerance ()
[DllImport("vtkplugin", EntryPoint="vtkLocator_GetTolerance_0")] public static extern 
bool GetTolerance_0(out double /*(double)*/ return_value, IntPtr /*(vtkLocator*)*/ callingObject);
...
bool GetBuildTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkLocator*)*/ callingObject);
