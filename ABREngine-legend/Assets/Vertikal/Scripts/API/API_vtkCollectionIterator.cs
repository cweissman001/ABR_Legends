...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkCollectionIterator*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkCollectionIterator*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkCollectionIterator* NewInstance()
// vtkCollectionIterator *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkCollectionIterator_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkCollectionIterator*)*/ return_value, IntPtr /*(vtkCollectionIterator*)*/ callingObject);

// static vtkCollectionIterator* New()
// static vtkCollectionIterator* New()
[DllImport("vtkplugin", EntryPoint="vtkCollectionIterator_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkCollectionIterator*)*/ return_value);
...
bool GetCollection_0(out IntPtr /*(vtkCollection*)*/ return_value, IntPtr /*(vtkCollectionIterator*)*/ callingObject);
...
bool IsDoneWithTraversal_0(out int /*(int)*/ return_value, IntPtr /*(vtkCollectionIterator*)*/ callingObject);

// vtkObject* GetCurrentObject()
// vtkObject* GetCurrentObject()
[DllImport("vtkplugin", EntryPoint="vtkCollectionIterator_GetCurrentObject_0")] public static extern 
bool GetCurrentObject_0(out IntPtr /*(vtkObject*)*/ return_value, IntPtr /*(vtkCollectionIterator*)*/ callingObject);
