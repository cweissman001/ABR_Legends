...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject, string /*(char*)*/ type);

// static vtkObject* SafeDownCast(vtkObjectBase * o)
// static vtkObject* SafeDownCast(vtkObjectBase *o)
[DllImport("vtkplugin", EntryPoint="vtkObject_SafeDownCast_0")] public static extern 
bool SafeDownCast_0(out IntPtr /*(vtkObject*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkObject* NewInstance()
// vtkObject *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkObject_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkObject*)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject);

// static vtkObject* New()
// static vtkObject *New()
[DllImport("vtkplugin", EntryPoint="vtkObject_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkObject*)*/ return_value);
...
bool GetDebug_0(out bool /*(bool)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject);
...
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject);
...
bool GetGlobalWarningDisplay_0(out int /*(int)*/ return_value);

// vtkCommand* GetCommand(unsigned long tag)
// vtkCommand *GetCommand(unsigned long tag)
[DllImport("vtkplugin", EntryPoint="vtkObject_GetCommand_0")] public static extern 
bool GetCommand_0(out IntPtr /*(vtkCommand*)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject, ulong /*(unsigned long)*/ tag);
...
bool HasObserver_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject, ulong /*(unsigned long)*/ evt, IntPtr /*(vtkCommand*)*/ ARG_0);
...
bool HasObserver_1(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject, string /*(char*)*/ evt, IntPtr /*(vtkCommand*)*/ ARG_0);
...
bool HasObserver_2(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject, ulong /*(unsigned long)*/ evt);

// vtkTypeBool HasObserver(const char * event)
// vtkTypeBool HasObserver(const char *event)
[DllImport("vtkplugin", EntryPoint="vtkObject_HasObserver_3")] public static extern 
bool HasObserver_3(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject, string /*(char*)*/ evt);

// int InvokeEvent(unsigned long event, void * callData)
// int InvokeEvent(unsigned long event, void *callData)
[DllImport("vtkplugin", EntryPoint="vtkObject_InvokeEvent_0")] public static extern 
bool InvokeEvent_0(out int /*(int)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject, ulong /*(unsigned long)*/ evt, IntPtr /*(void*)*/ callData);

// int InvokeEvent(const char * event, void * callData)
// int InvokeEvent(const char *event, void *callData)
[DllImport("vtkplugin", EntryPoint="vtkObject_InvokeEvent_1")] public static extern 
bool InvokeEvent_1(out int /*(int)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject, string /*(char*)*/ evt, IntPtr /*(void*)*/ callData);

// int InvokeEvent(unsigned long event)
// int InvokeEvent(unsigned long event)
[DllImport("vtkplugin", EntryPoint="vtkObject_InvokeEvent_2")] public static extern 
bool InvokeEvent_2(out int /*(int)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject, ulong /*(unsigned long)*/ evt);

// int InvokeEvent(const char * event)
// int InvokeEvent(const char *event)
[DllImport("vtkplugin", EntryPoint="vtkObject_InvokeEvent_3")] public static extern 
bool InvokeEvent_3(out int /*(int)*/ return_value, IntPtr /*(vtkObject*)*/ callingObject, string /*(char*)*/ evt);
