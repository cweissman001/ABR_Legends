...
bool New_0(out IntPtr /*(vtkRegularPolygonSource*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkRegularPolygonSource*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);
...
bool NewInstance_0(out IntPtr /*(vtkRegularPolygonSource*)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject);
...
bool GetNumberOfSidesMinValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject);
...
bool GetNumberOfSidesMaxValue_0(out int /*(int)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject);
...
bool GetNumberOfSides_0(out int /*(int)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject);
...
bool GetCenter_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject);
...
bool GetNormal_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject);
...
bool GetRadius_0(out double /*(double)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject);
...
bool SetGeneratePolygon_0(IntPtr /*(vtkRegularPolygonSource*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetGeneratePolygon_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject);
...
bool SetGeneratePolyline_0(IntPtr /*(vtkRegularPolygonSource*)*/ callingObject, bool /*(vtkTypeBool)*/ _arg);
...
bool GetGeneratePolyline_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject);
...
bool GetOutputPointsPrecision_0(out int /*(int)*/ return_value, IntPtr /*(vtkRegularPolygonSource*)*/ callingObject);
