...
bool New_0(out IntPtr /*(vtkProp3DCollection*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkProp3DCollection*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkProp3DCollection*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkProp3DCollection* NewInstance()
// vtkProp3DCollection *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkProp3DCollection_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkProp3DCollection*)*/ return_value, IntPtr /*(vtkProp3DCollection*)*/ callingObject);
...
bool GetNextProp3D_0(out IntPtr /*(vtkProp3D*)*/ return_value, IntPtr /*(vtkProp3DCollection*)*/ callingObject);

// vtkProp3D* GetLastProp3D()
// vtkProp3D *GetLastProp3D()
[DllImport("vtkplugin", EntryPoint="vtkProp3DCollection_GetLastProp3D_0")] public static extern 
bool GetLastProp3D_0(out IntPtr /*(vtkProp3D*)*/ return_value, IntPtr /*(vtkProp3DCollection*)*/ callingObject);
