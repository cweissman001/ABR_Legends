...
bool New_0(out IntPtr /*(vtkMatrix4x4*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkMatrix4x4*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkMatrix4x4*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkMatrix4x4* NewInstance()
// vtkMatrix4x4 *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkMatrix4x4_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkMatrix4x4*)*/ return_value, IntPtr /*(vtkMatrix4x4*)*/ callingObject);
...
bool MultiplyPoint_4(out float[] /*(float*)*/ return_value, IntPtr /*(vtkMatrix4x4*)*/ callingObject, float /*(float[4])*/ []in_var);

// float* MultiplyFloatPoint(const float in[4])
// float *MultiplyFloatPoint(const float in[4])
[DllImport("vtkplugin", EntryPoint="vtkMatrix4x4_MultiplyFloatPoint_0")] public static extern 
bool MultiplyFloatPoint_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkMatrix4x4*)*/ callingObject, float /*(float[4])*/ []in_var);

// double* MultiplyDoublePoint(const double in[4])
// double *MultiplyDoublePoint(const double in[4])
[DllImport("vtkplugin", EntryPoint="vtkMatrix4x4_MultiplyDoublePoint_0")] public static extern 
bool MultiplyDoublePoint_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkMatrix4x4*)*/ callingObject, double /*(double[4])*/ []in_var);
...
bool Determinant_0(out double /*(double)*/ return_value, IntPtr /*(vtkMatrix4x4*)*/ callingObject);

// static double Determinant(const double elements[16])
// static double Determinant(const double elements[16])
[DllImport("vtkplugin", EntryPoint="vtkMatrix4x4_Determinant_1")] public static extern 
bool Determinant_1(out double /*(double)*/ return_value, double /*(double[16])*/ []elements);
...
bool GetElement_0(out double /*(double)*/ return_value, IntPtr /*(vtkMatrix4x4*)*/ callingObject, int /*(int)*/ i, int /*(int)*/ j);

// double* GetData()
// double *GetData()
[DllImport("vtkplugin", EntryPoint="vtkMatrix4x4_GetData_0")] public static extern 
bool GetData_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkMatrix4x4*)*/ callingObject);
