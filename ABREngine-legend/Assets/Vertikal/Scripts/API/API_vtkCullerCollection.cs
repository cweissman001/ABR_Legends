...
bool New_0(out IntPtr /*(vtkCullerCollection*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkCullerCollection*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkCullerCollection*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkCullerCollection* NewInstance()
// vtkCullerCollection *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkCullerCollection_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkCullerCollection*)*/ return_value, IntPtr /*(vtkCullerCollection*)*/ callingObject);
...
bool GetNextItem_0(out IntPtr /*(vtkCuller*)*/ return_value, IntPtr /*(vtkCullerCollection*)*/ callingObject);

// vtkCuller* GetLastItem()
// vtkCuller *GetLastItem()
[DllImport("vtkplugin", EntryPoint="vtkCullerCollection_GetLastItem_0")] public static extern 
bool GetLastItem_0(out IntPtr /*(vtkCuller*)*/ return_value, IntPtr /*(vtkCullerCollection*)*/ callingObject);
