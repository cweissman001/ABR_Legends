...
bool New_0(out IntPtr /*(vtkCellTypes*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkCellTypes*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkCellTypes*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkCellTypes* NewInstance()
// vtkCellTypes *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkCellTypes_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkCellTypes*)*/ return_value, IntPtr /*(vtkCellTypes*)*/ callingObject);

// int Allocate(int sz = 512, int ext = 1000)
// int Allocate(int sz=512, int ext=1000)
[DllImport("vtkplugin", EntryPoint="vtkCellTypes_Allocate_0")] public static extern 
bool Allocate_0(out int /*(int)*/ return_value, IntPtr /*(vtkCellTypes*)*/ callingObject, int /*(int)*/ sz, int /*(int)*/ ext);
...
bool GetCellLocation_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkCellTypes*)*/ callingObject, long /*(vtkIdType)*/ cellId);
...
bool GetNumberOfTypes_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkCellTypes*)*/ callingObject);

// int IsType(unsigned char type)
// int IsType(unsigned char type)
[DllImport("vtkplugin", EntryPoint="vtkCellTypes_IsType_0")] public static extern 
bool IsType_0(out int /*(int)*/ return_value, IntPtr /*(vtkCellTypes*)*/ callingObject, char /*(unsigned char)*/ type);
...
bool InsertNextType_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkCellTypes*)*/ callingObject, char /*(unsigned char)*/ type);
...
bool GetCellType_0(out char /*(unsigned char)*/ return_value, IntPtr /*(vtkCellTypes*)*/ callingObject, long /*(vtkIdType)*/ cellId);
...
bool GetActualMemorySize_0(out ulong /*(unsigned long)*/ return_value, IntPtr /*(vtkCellTypes*)*/ callingObject);
...
bool GetClassNameFromTypeId_0(out byte[] /*(char*)*/ return_value, int /*(int)*/ typeId);

// static int GetTypeIdFromClassName(const char * classname)
// static int GetTypeIdFromClassName(const char* classname)
[DllImport("vtkplugin", EntryPoint="vtkCellTypes_GetTypeIdFromClassName_0")] public static extern 
bool GetTypeIdFromClassName_0(out int /*(int)*/ return_value, string /*(char*)*/ classname);

// static int IsLinear(unsigned char type)
// static int IsLinear(unsigned char type)
[DllImport("vtkplugin", EntryPoint="vtkCellTypes_IsLinear_0")] public static extern 
bool IsLinear_0(out int /*(int)*/ return_value, char /*(unsigned char)*/ type);
