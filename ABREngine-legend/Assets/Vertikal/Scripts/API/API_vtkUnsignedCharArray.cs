...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkUnsignedCharArray*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkUnsignedCharArray* NewInstance()
// vtkUnsignedCharArray *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkUnsignedCharArray_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value, IntPtr /*(vtkUnsignedCharArray*)*/ callingObject);

// static vtkUnsignedCharArray* New()
// static vtkUnsignedCharArray* New()
[DllImport("vtkplugin", EntryPoint="vtkUnsignedCharArray_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value);
...
bool FastDownCast_0(out IntPtr /*(vtkUnsignedCharArray*)*/ return_value, IntPtr /*(vtkAbstractArray*)*/ source);
...
bool GetDataTypeValueMin_0(out char /*(unsigned char)*/ return_value);
...
bool GetDataTypeValueMax_0(out char /*(unsigned char)*/ return_value);
