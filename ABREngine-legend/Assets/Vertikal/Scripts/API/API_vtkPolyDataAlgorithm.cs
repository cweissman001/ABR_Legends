...
bool New_0(out IntPtr /*(vtkPolyDataAlgorithm*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPolyDataAlgorithm*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPolyDataAlgorithm*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkPolyDataAlgorithm* NewInstance()
// vtkPolyDataAlgorithm *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkPolyDataAlgorithm_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkPolyDataAlgorithm*)*/ return_value, IntPtr /*(vtkPolyDataAlgorithm*)*/ callingObject);

// vtkPolyData* GetOutput()
// vtkPolyData* GetOutput()
[DllImport("vtkplugin", EntryPoint="vtkPolyDataAlgorithm_GetOutput_0")] public static extern 
bool GetOutput_0(out IntPtr /*(vtkPolyData*)*/ return_value, IntPtr /*(vtkPolyDataAlgorithm*)*/ callingObject);

// vtkPolyData* GetOutput(int ARG_0)
// vtkPolyData* GetOutput(int)
[DllImport("vtkplugin", EntryPoint="vtkPolyDataAlgorithm_GetOutput_1")] public static extern 
bool GetOutput_1(out IntPtr /*(vtkPolyData*)*/ return_value, IntPtr /*(vtkPolyDataAlgorithm*)*/ callingObject, int /*(int)*/ ARG_0);
...
bool GetInput_0(out IntPtr /*(vtkDataObject*)*/ return_value, IntPtr /*(vtkPolyDataAlgorithm*)*/ callingObject);

// vtkDataObject* GetInput(int port)
// vtkDataObject *GetInput(int port)
[DllImport("vtkplugin", EntryPoint="vtkPolyDataAlgorithm_GetInput_1")] public static extern 
bool GetInput_1(out IntPtr /*(vtkDataObject*)*/ return_value, IntPtr /*(vtkPolyDataAlgorithm*)*/ callingObject, int /*(int)*/ port);

// vtkPolyData* GetPolyDataInput(int port)
// vtkPolyData *GetPolyDataInput(int port)
[DllImport("vtkplugin", EntryPoint="vtkPolyDataAlgorithm_GetPolyDataInput_0")] public static extern 
bool GetPolyDataInput_0(out IntPtr /*(vtkPolyData*)*/ return_value, IntPtr /*(vtkPolyDataAlgorithm*)*/ callingObject, int /*(int)*/ port);
