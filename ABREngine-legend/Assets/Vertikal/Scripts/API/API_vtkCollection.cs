...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkCollection*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkCollection*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkCollection* NewInstance()
// vtkCollection *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkCollection_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkCollection*)*/ return_value, IntPtr /*(vtkCollection*)*/ callingObject);

// static vtkCollection* New()
// static vtkCollection *New()
[DllImport("vtkplugin", EntryPoint="vtkCollection_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkCollection*)*/ return_value);
...
bool IsItemPresent_0(out int /*(int)*/ return_value, IntPtr /*(vtkCollection*)*/ callingObject, IntPtr /*(vtkObject*)*/ a);

// int GetNumberOfItems()
// int GetNumberOfItems()
[DllImport("vtkplugin", EntryPoint="vtkCollection_GetNumberOfItems_0")] public static extern 
bool GetNumberOfItems_0(out int /*(int)*/ return_value, IntPtr /*(vtkCollection*)*/ callingObject);
...
bool GetNextItemAsObject_0(out IntPtr /*(vtkObject*)*/ return_value, IntPtr /*(vtkCollection*)*/ callingObject);

// vtkObject* GetItemAsObject(int i)
// vtkObject *GetItemAsObject(int i)
[DllImport("vtkplugin", EntryPoint="vtkCollection_GetItemAsObject_0")] public static extern 
bool GetItemAsObject_0(out IntPtr /*(vtkObject*)*/ return_value, IntPtr /*(vtkCollection*)*/ callingObject, int /*(int)*/ i);

// vtkCollectionIterator* NewIterator()
// vtkCollectionIterator* NewIterator()
[DllImport("vtkplugin", EntryPoint="vtkCollection_NewIterator_0")] public static extern 
bool NewIterator_0(out IntPtr /*(vtkCollectionIterator*)*/ return_value, IntPtr /*(vtkCollection*)*/ callingObject);
