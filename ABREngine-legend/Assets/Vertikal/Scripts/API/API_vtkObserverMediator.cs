...
bool New_0(out IntPtr /*(vtkObserverMediator*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkObserverMediator*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkObserverMediator*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkObserverMediator* NewInstance()
// vtkObserverMediator *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkObserverMediator_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkObserverMediator*)*/ return_value, IntPtr /*(vtkObserverMediator*)*/ callingObject);
...
bool GetInteractor_0(out IntPtr /*(vtkRenderWindowInteractor*)*/ return_value, IntPtr /*(vtkObserverMediator*)*/ callingObject);
...
bool RequestCursorShape_0(out int /*(int)*/ return_value, IntPtr /*(vtkObserverMediator*)*/ callingObject, IntPtr /*(vtkInteractorObserver*)*/ ARG_0, int /*(int)*/ cursorShape);
