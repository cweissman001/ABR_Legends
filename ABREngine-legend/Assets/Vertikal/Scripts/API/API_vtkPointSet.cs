...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPointSet*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkPointSet* NewInstance()
// vtkPointSet *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkPointSet_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkPointSet*)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject);
...
bool GetNumberOfPoints_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject);
...
bool FindPoint_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject, double /*(double[3])*/ []x);

// vtkIdType FindPoint(double x, double y, double z)
// vtkIdType FindPoint(double x, double y, double z)
[DllImport("vtkplugin", EntryPoint="vtkPointSet_FindPoint_1")] public static extern 
bool FindPoint_1(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool FindCell_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject, double /*(double[3])*/ []x, IntPtr /*(vtkCell*)*/ cell, long /*(vtkIdType)*/ cellId, double /*(double)*/ tol2, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, double[] /*(double*)*/ weights);
...
bool FindCell_1(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject, double /*(double[3])*/ []x, IntPtr /*(vtkCell*)*/ cell, IntPtr /*(vtkGenericCell*)*/ gencell, long /*(vtkIdType)*/ cellId, double /*(double)*/ tol2, IntPtr /*(int&)*/ subId, double /*(double[3])*/ []pcoords, double[] /*(double*)*/ weights);

// double* GetPoint(vtkIdType ptId)
// double *GetPoint(vtkIdType ptId)
[DllImport("vtkplugin", EntryPoint="vtkPointSet_GetPoint_1")] public static extern 
bool GetPoint_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject, long /*(vtkIdType)*/ ptId);

// vtkCellIterator* NewCellIterator()
// vtkCellIterator* NewCellIterator()
[DllImport("vtkplugin", EntryPoint="vtkPointSet_NewCellIterator_0")] public static extern 
bool NewCellIterator_0(out IntPtr /*(vtkCellIterator*)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject);

// vtkMTimeType GetMTime()
// vtkMTimeType GetMTime()
[DllImport("vtkplugin", EntryPoint="vtkPointSet_GetMTime_0")] public static extern 
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject);
...
bool GetPoints_0(out IntPtr /*(vtkPoints*)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject);

// long GetActualMemorySize()
// unsigned long GetActualMemorySize()
[DllImport("vtkplugin", EntryPoint="vtkPointSet_GetActualMemorySize_0")] public static extern 
bool GetActualMemorySize_0(out ulong /*(unsigned long)*/ return_value, IntPtr /*(vtkPointSet*)*/ callingObject);
