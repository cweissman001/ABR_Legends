...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkCommand*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkCommand*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkCommand* NewInstance()
// vtkCommand *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkCommand_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkCommand*)*/ return_value, IntPtr /*(vtkCommand*)*/ callingObject);
...
bool GetStringFromEventId_0(out byte[] /*(char*)*/ return_value, ulong /*(unsigned long)*/ evt);
...
bool GetEventIdFromString_0(out ulong /*(unsigned long)*/ return_value, string /*(char*)*/ evt);
...
bool EventHasData_0(out bool /*(bool)*/ return_value, ulong /*(unsigned long)*/ evt);
...
bool GetAbortFlag_0(out int /*(int)*/ return_value, IntPtr /*(vtkCommand*)*/ callingObject);
...
bool GetPassiveObserver_0(out int /*(int)*/ return_value, IntPtr /*(vtkCommand*)*/ callingObject);
