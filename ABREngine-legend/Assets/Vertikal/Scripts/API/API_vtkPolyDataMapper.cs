...
bool New_0(out IntPtr /*(vtkPolyDataMapper*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPolyDataMapper*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPolyDataMapper*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkPolyDataMapper* NewInstance()
// vtkPolyDataMapper *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkPolyDataMapper_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkPolyDataMapper*)*/ return_value, IntPtr /*(vtkPolyDataMapper*)*/ callingObject);
...
bool GetInput_0(out IntPtr /*(vtkPolyData*)*/ return_value, IntPtr /*(vtkPolyDataMapper*)*/ callingObject);
...
bool GetPiece_0(out int /*(int)*/ return_value, IntPtr /*(vtkPolyDataMapper*)*/ callingObject);
...
bool GetNumberOfPieces_0(out int /*(int)*/ return_value, IntPtr /*(vtkPolyDataMapper*)*/ callingObject);
...
bool GetNumberOfSubPieces_0(out int /*(int)*/ return_value, IntPtr /*(vtkPolyDataMapper*)*/ callingObject);
...
bool GetGhostLevel_0(out int /*(int)*/ return_value, IntPtr /*(vtkPolyDataMapper*)*/ callingObject);

// double* GetBounds()
// double *GetBounds()
[DllImport("vtkplugin", EntryPoint="vtkPolyDataMapper_GetBounds_0")] public static extern 
bool GetBounds_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkPolyDataMapper*)*/ callingObject);
