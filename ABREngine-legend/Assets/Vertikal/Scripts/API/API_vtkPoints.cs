...
bool New_0(out IntPtr /*(vtkPoints*)*/ return_value, int /*(int)*/ dataType);

// static vtkPoints* New()
// static vtkPoints *New()
[DllImport("vtkplugin", EntryPoint="vtkPoints_New_1")] public static extern 
bool New_1(out IntPtr /*(vtkPoints*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPoints*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkPoints* NewInstance()
// vtkPoints *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkPoints_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkPoints*)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject);
...
bool Allocate_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, long /*(vtkIdType)*/ sz, long /*(vtkIdType)*/ ext);
...
bool GetData_0(out IntPtr /*(vtkDataArray*)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject);

// virtual int GetDataType()
// virtual int GetDataType()
[DllImport("vtkplugin", EntryPoint="vtkPoints_GetDataType_0")] public static extern 
bool GetDataType_0(out int /*(int)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject);
...
bool GetVoidPointer_0(out IntPtr /*(IntPtr*)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, int /*(int)*/ id);
...
bool GetActualMemorySize_0(out ulong /*(unsigned long)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject);

// vtkIdType GetNumberOfPoints()
// vtkIdType GetNumberOfPoints()
[DllImport("vtkplugin", EntryPoint="vtkPoints_GetNumberOfPoints_0")] public static extern 
bool GetNumberOfPoints_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject);

// double* GetPoint(vtkIdType id)
// double *GetPoint(vtkIdType id)
[DllImport("vtkplugin", EntryPoint="vtkPoints_GetPoint_0")] public static extern 
bool GetPoint_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, long /*(vtkIdType)*/ id);
...
bool InsertNextPoint_0(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, float /*(float[3])*/ []x);

// vtkIdType InsertNextPoint(const double x[3])
// vtkIdType InsertNextPoint(const double x[3])
[DllImport("vtkplugin", EntryPoint="vtkPoints_InsertNextPoint_1")] public static extern 
bool InsertNextPoint_1(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, double /*(double[3])*/ []x);

// vtkIdType InsertNextPoint(double x, double y, double z)
// vtkIdType InsertNextPoint(double x, double y, double z)
[DllImport("vtkplugin", EntryPoint="vtkPoints_InsertNextPoint_2")] public static extern 
bool InsertNextPoint_2(out long /*(vtkIdType)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool Resize_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject, long /*(vtkIdType)*/ numPoints);
...
bool GetBounds_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject);
...
bool GetMTime_0(out ulong /*(vtkMTimeType)*/ return_value, IntPtr /*(vtkPoints*)*/ callingObject);
