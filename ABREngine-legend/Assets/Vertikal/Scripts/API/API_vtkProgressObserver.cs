...
bool New_0(out IntPtr /*(vtkProgressObserver*)*/ return_value);
...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkProgressObserver*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkProgressObserver*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkProgressObserver* NewInstance()
// vtkProgressObserver *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkProgressObserver_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkProgressObserver*)*/ return_value, IntPtr /*(vtkProgressObserver*)*/ callingObject);
...
bool GetProgress_0(out double /*(double)*/ return_value, IntPtr /*(vtkProgressObserver*)*/ callingObject);
