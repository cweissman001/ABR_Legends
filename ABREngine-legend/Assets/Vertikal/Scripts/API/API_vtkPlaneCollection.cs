...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkPlaneCollection*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkPlaneCollection*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkPlaneCollection* NewInstance()
// vtkPlaneCollection *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkPlaneCollection_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkPlaneCollection*)*/ return_value, IntPtr /*(vtkPlaneCollection*)*/ callingObject);

// static vtkPlaneCollection* New()
// static vtkPlaneCollection *New()
[DllImport("vtkplugin", EntryPoint="vtkPlaneCollection_New_0")] public static extern 
bool New_0(out IntPtr /*(vtkPlaneCollection*)*/ return_value);
...
bool GetNextItem_0(out IntPtr /*(vtkPlane*)*/ return_value, IntPtr /*(vtkPlaneCollection*)*/ callingObject);

// vtkPlane* GetItem(int i)
// vtkPlane *GetItem(int i)
[DllImport("vtkplugin", EntryPoint="vtkPlaneCollection_GetItem_0")] public static extern 
bool GetItem_0(out IntPtr /*(vtkPlane*)*/ return_value, IntPtr /*(vtkPlaneCollection*)*/ callingObject, int /*(int)*/ i);
