...
bool IsA_0(out bool /*(vtkTypeBool)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, string /*(char*)*/ type);
...
bool SafeDownCast_0(out IntPtr /*(vtkLinearTransform*)*/ return_value, IntPtr /*(vtkObjectBase*)*/ o);

// vtkLinearTransform* NewInstance()
// vtkLinearTransform *NewInstance()
[DllImport("vtkplugin", EntryPoint="vtkLinearTransform_NewInstance_0")] public static extern 
bool NewInstance_0(out IntPtr /*(vtkLinearTransform*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject);
...
bool TransformNormal_2(out double[] /*(double*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool TransformNormal_3(out double[] /*(double*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, double /*(double[3])*/ []normal);
...
bool TransformFloatNormal_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, float /*(float)*/ x, float /*(float)*/ y, float /*(float)*/ z);
...
bool TransformFloatNormal_1(out float[] /*(float*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, float /*(float[3])*/ []normal);
...
bool TransformDoubleNormal_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool TransformDoubleNormal_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, double /*(double[3])*/ []normal);
...
bool TransformVector_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool TransformVector_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, double /*(double[3])*/ []normal);
...
bool TransformFloatVector_0(out float[] /*(float*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, float /*(float)*/ x, float /*(float)*/ y, float /*(float)*/ z);
...
bool TransformFloatVector_1(out float[] /*(float*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, float /*(float[3])*/ []vec);

// double* TransformDoubleVector(double x, double y, double z)
// double *TransformDoubleVector(double x, double y, double z)
[DllImport("vtkplugin", EntryPoint="vtkLinearTransform_TransformDoubleVector_0")] public static extern 
bool TransformDoubleVector_0(out double[] /*(double*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, double /*(double)*/ x, double /*(double)*/ y, double /*(double)*/ z);
...
bool TransformDoubleVector_1(out double[] /*(double*)*/ return_value, IntPtr /*(vtkLinearTransform*)*/ callingObject, double /*(double[3])*/ []vec);
