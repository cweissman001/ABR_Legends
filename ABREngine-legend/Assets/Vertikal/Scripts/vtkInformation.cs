...
// "void Set(vtkInformationIntegerVectorKey* key, const int* value, int length)"
public void Set(vtkInformationIntegerVectorKey /*(vtkInformationIntegerVectorKey*)*/ key, int /*(int*)*/ []value, int /*(int)*/ length) {
...
// "void Get(vtkInformationIntegerVectorKey* key, int* value)"
public void Get(vtkInformationIntegerVectorKey /*(vtkInformationIntegerVectorKey*)*/ key, int /*(int*)*/ []value) {
...
// "void Set(vtkInformationIntegerPointerKey* key, int* value, int length)"
public void Set(vtkInformationIntegerPointerKey /*(vtkInformationIntegerPointerKey*)*/ key, int /*(int*)*/ []value, int /*(int)*/ length) {
...
// "void Get(vtkInformationIntegerPointerKey* key, int* value)"
public void Get(vtkInformationIntegerPointerKey /*(vtkInformationIntegerPointerKey*)*/ key, int /*(int*)*/ []value) {
...
// "void Set(vtkInformationDoubleVectorKey* key, const double* value, int length)"
public void Set(vtkInformationDoubleVectorKey /*(vtkInformationDoubleVectorKey*)*/ key, double /*(double*)*/ []value, int /*(int)*/ length) {
...
// "void Get(vtkInformationDoubleVectorKey* key, double* value)"
public void Get(vtkInformationDoubleVectorKey /*(vtkInformationDoubleVectorKey*)*/ key, double /*(double*)*/ []value) {
