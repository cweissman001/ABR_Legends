...
//	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	...
	VTK_API.API_vtkTransform.New_0(out returnPointer);
...
//	ReturnPointer returnPointer = new ReturnPointer(new bool());
	...
	VTK_API.API_vtkTransform.IsTypeOf_0(out returnPointer, type);
...
//	ReturnPointer returnPointer = new ReturnPointer(new bool());
	bool returnPointer = new bool();
	VTK_API.API_vtkTransform.IsA_0(out returnPointer, this, type);
//	return (bool)returnPointer;
	return returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	IntPtr returnPointer = new IntPtr();
	VTK_API.API_vtkTransform.SafeDownCast_0(out returnPointer, o);
//	return (vtkTransform)(IntPtr)returnPointer;
	return (vtkTransform)(IntPtr)returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	IntPtr returnPointer = new IntPtr();
	VTK_API.API_vtkTransform.NewInstance_0(out returnPointer, this);
//	return (vtkTransform)(IntPtr)returnPointer;
	return (vtkTransform)(IntPtr)returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new int());
	...
	VTK_API.API_vtkTransform.GetNumberOfConcatenatedTransforms_0(out returnPointer, this);
...
//	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	IntPtr returnPointer = new IntPtr();
	VTK_API.API_vtkTransform.GetConcatenatedTransform_0(out returnPointer, this, i);
...
//	ReturnPointer returnPointer = new ReturnPointer(new double());
	...
	VTK_API.API_vtkTransform.GetOrientation_2(out returnPointer, this);
...
//	ReturnPointer returnPointer = new ReturnPointer(new double());
	double[] returnPointer = new double[1];
	VTK_API.API_vtkTransform.GetOrientationWXYZ_2(out returnPointer, this);
//	return (double)returnPointer;
	return returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new double());
	double[] returnPointer = new double[1];
	VTK_API.API_vtkTransform.GetPosition_2(out returnPointer, this);
//	return (double)returnPointer;
	return returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new double());
	double[] returnPointer = new double[1];
	VTK_API.API_vtkTransform.GetScale_2(out returnPointer, this);
//	return (double)returnPointer;
	return returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	IntPtr returnPointer = new IntPtr();
	VTK_API.API_vtkTransform.GetInput_0(out returnPointer, this);
//	return (vtkLinearTransform)(IntPtr)returnPointer;
	return (vtkLinearTransform)(IntPtr)returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new int());
	int returnPointer = new int();
	VTK_API.API_vtkTransform.GetInverseFlag_0(out returnPointer, this);
//	return (int)returnPointer;
	return returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new int());
	int returnPointer = new int();
	VTK_API.API_vtkTransform.CircuitCheck_0(out returnPointer, this, transform);
//	return (int)returnPointer;
	return returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	IntPtr returnPointer = new IntPtr();
	VTK_API.API_vtkTransform.GetInverse_1(out returnPointer, this);
...
//	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	IntPtr returnPointer = new IntPtr();
	VTK_API.API_vtkTransform.MakeTransform_0(out returnPointer, this);
//	return (vtkAbstractTransform)(IntPtr)returnPointer;
	return (vtkAbstractTransform)(IntPtr)returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new ulong());
	...
	VTK_API.API_vtkTransform.GetMTime_0(out returnPointer, this);
