...
//	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	...
	VTK_API.API_vtkMatrix4x4.New_0(out returnPointer);
...
//	ReturnPointer returnPointer = new ReturnPointer(new bool());
	...
	VTK_API.API_vtkMatrix4x4.IsTypeOf_0(out returnPointer, type);
...
//	ReturnPointer returnPointer = new ReturnPointer(new bool());
	bool returnPointer = new bool();
	VTK_API.API_vtkMatrix4x4.IsA_0(out returnPointer, this, type);
//	return (bool)returnPointer;
	return returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	IntPtr returnPointer = new IntPtr();
	VTK_API.API_vtkMatrix4x4.SafeDownCast_0(out returnPointer, o);
//	return (vtkMatrix4x4)(IntPtr)returnPointer;
	return (vtkMatrix4x4)(IntPtr)returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new IntPtr());
	IntPtr returnPointer = new IntPtr();
	VTK_API.API_vtkMatrix4x4.NewInstance_0(out returnPointer, this);
//	return (vtkMatrix4x4)(IntPtr)returnPointer;
	return (vtkMatrix4x4)(IntPtr)returnPointer;
}
...
// "float *MultiplyPoint(const float in[4])"
public float[] MultiplyPoint(float /*(float[4])*/ []in_var) {
//	float
//	ReturnPointer returnPointer = new ReturnPointer(new float());
	float[] returnPointer = new float[1];
	VTK_API.API_vtkMatrix4x4.MultiplyPoint_4(out returnPointer, this, in_var);
...
// "float *MultiplyFloatPoint(const float in[4])"
public float[] MultiplyFloatPoint(float /*(float[4])*/ []in_var) {
//	float
//	ReturnPointer returnPointer = new ReturnPointer(new float());
	float[] returnPointer = new float[1];
	VTK_API.API_vtkMatrix4x4.MultiplyFloatPoint_0(out returnPointer, this, in_var);
//	return (float)returnPointer;
	return returnPointer;
}
...
// "double *MultiplyDoublePoint(const double in[4])"
public double[] MultiplyDoublePoint(double /*(double[4])*/ []in_var) {
//	double
//	ReturnPointer returnPointer = new ReturnPointer(new double());
	double[] returnPointer = new double[1];
	VTK_API.API_vtkMatrix4x4.MultiplyDoublePoint_0(out returnPointer, this, in_var);
...
//	ReturnPointer returnPointer = new ReturnPointer(new double());
	...
	VTK_API.API_vtkMatrix4x4.Determinant_0(out returnPointer, this);
//	return (double)returnPointer;
	return returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new double());
	double returnPointer = new double();
	VTK_API.API_vtkMatrix4x4.Determinant_1(out returnPointer, elements);
//	return (double)returnPointer;
	return returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new double());
	double returnPointer = new double();
	VTK_API.API_vtkMatrix4x4.GetElement_0(out returnPointer, this, i, j);
//	return (double)returnPointer;
	return returnPointer;
}
...
//	ReturnPointer returnPointer = new ReturnPointer(new double());
	double[] returnPointer = new double[1];
	VTK_API.API_vtkMatrix4x4.GetData_0(out returnPointer, this);
//	return (double)returnPointer;
	return returnPointer;
}
