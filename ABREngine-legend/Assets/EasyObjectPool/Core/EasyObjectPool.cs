...
namespace MarchingBytes {
	...
	public class EasyObjectPool : MonoBehaviour {
		...
		public static EasyObjectPool _instance;
		public static EasyObjectPool instance {
			get { 
				if (_instance == null)
				{
					_instance = GameObject.FindObjectOfType<EasyObjectPool>();
					if(_instance == null)
					{
						_instance = new GameObject("Object Pools").AddComponent<EasyObjectPool>();
					}
				}
				return _instance;
			}
